...
section SELECTALL is not intended for general use.
...
Currently, the following classes are available, along with their section names:
    ...
    blas64__opt_info:SELECTALL               # usage recommended (general ILP64 BLAS, 64_ symbol suffix)
    blas_ilp64_opt_info:SELECTALL            # usage recommended (general ILP64 BLAS)
    blas_ilp64_plain_opt_info:SELECTALL      # usage recommended (general ILP64 BLAS, no symbol suffix)
    blas_info:blas
    blas_mkl_info:mkl
    blas_opt_info:SELECTALL                  # usage recommended
    ...
    lapack64__opt_info:SELECTALL             # usage recommended (general ILP64 LAPACK, 64_ symbol suffix)
    lapack_atlas_3_10_info:atlas
    lapack_atlas_3_10_threads_info:atlas
    lapack_atlas_info:atlas
    lapack_atlas_threads_info:atlas
    lapack_ilp64_opt_info:SELECTALL          # usage recommended (general ILP64 LAPACK)
    lapack_ilp64_plain_opt_info:SELECTALL    # usage recommended (general ILP64 LAPACK, no symbol suffix)
    lapack_info:lapack
    lapack_mkl_info:mkl
    lapack_opt_info:SELECTALL                # usage recommended
...
class system_info:
    ...
    search_static_first = 0
    # The base-class section name is a random word "SELECTALL" and is not really
