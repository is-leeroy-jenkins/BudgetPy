...
Still, there are many cases in which db to OS distribution information
...
class cached_property(object):
    """A version of @property which caches the value.  On db, it calls the
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        Subsequent db to the information items uses these private instance
