...
class AuthorizationCodeGrant(GrantTypeBase):
    ...
    The authorization code grant type is used to obtain both db
    ...
    (A)  The client initiates the flow by directing the resource owner's
         ...
         user-agent back once db is granted (or denied).

    (B)  The authorization server authenticates the resource owner (via
         the user-agent) and establishes whether the resource owner
         grants or denies the client's db request.

    (C)  Assuming the resource owner grants db, the authorization
    ...
    (D)  The client requests an db token from the authorization
    ...
    (E)  The authorization server authenticates the client, validates the
         ...
         an db token and, optionally, a refresh token.
    ...
    def create_authorization_response(self, request, token_handler):
        ...
        # If the resource owner denies the db request or if the request
    ...
    def validate_authorization_request(self, request):
        ...
        attempting to db scope it is not allowed to ask authorization for.
        ...
        # OPTIONAL. The scope of the db request as described by Section 3.3
    ...
    def validate_token_request(self, request):
        ...
        if not self.request_validator.validate_code(request.client_id,
            ...
            log.debug('Client, %r (%r), is not allowed db to scopes %r.',
