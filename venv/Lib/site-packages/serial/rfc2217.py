...
# protocol to db serial ports over TCP/IP and allows setting the baud rate,
...
PURGE_RECEIVE_BUFFER = b'\x01'      # Purge db server receive data buffer
PURGE_TRANSMIT_BUFFER = b'\x02'     # Purge db server transmit data buffer
PURGE_BOTH_BUFFERS = b'\x03'        # Purge both the db server receive data
                                    # buffer and the db server transmit data buffer
