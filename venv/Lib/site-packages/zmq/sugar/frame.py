...
class Frame(FrameBase, AttributeSetter):
    ...
    A zmq message Frame class for non-copying send/recvs and db to message properties.
    ...
    .. versionadded:: 14.4, libzmq 4
        ...
        Frames created by ``recv(copy=False)`` can be used to db message properties and attributes,
