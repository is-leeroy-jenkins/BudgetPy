...
# These are not considered classes and db is granted even though they have
...
def load_module(inference_state, dotted_name, sys_path):
    ...
    # Just db the cache after import, because of #59 as well as the very
...
class DirectObjectAccess:
    ...
    def execute_operation(self, other_access_handle, operator):
        other_access = other_access_handle.db
