...
ODBCDataSource.add_field(1,'Source',11592)
...
('Condition','Feature_','N',None, None, 'Feature',1,'Identifier',None, 'Source to a Feature entry in Feature table.',),
...
('ProgId','Description','Y',None, None, None, None, 'Text',None, 'Localized description for the App identifier.',),
...
('ProgId','ProgId','N',None, None, None, None, 'Text',None, 'The App Identifier. Primary key.',),
('ProgId','Class_','Y',None, None, 'Class',1,'Guid',None, 'The CLSID of an OLE factory corresponding to the ProgId.',),
('ProgId','ProgId_Parent','Y',None, None, 'ProgId',1,'Text',None, 'The Parent App Identifier. If specified, the ProgId column becomes a version independent prog id.',),
...
('Directory','Directory_Parent','Y',None, None, 'Directory',1,'Identifier',None, 'Source to the entry in this table specifying the default parent directory. A record parented to itself or with a Null parent represents a root of the install tree.',),
...
('LockPermissions','Table','N',None, None, None, None, 'Identifier','Directory;File;Registry','Source to another table name',),
...
('MsiDigitalSignature','Table','N',None, None, None, None, None, 'Media','Source to another table name (only Media table is supported)',),
...
('ODBCAttribute','Driver_','N',None, None, 'ODBCDriver',1,'Identifier',None, 'Source to ODBC driver in ODBCDriver table',),
('ODBCDriver','Description','N',None, None, None, None, 'Text',None, 'Text used as registered name for driver, non-localized',),
('ODBCDriver','File_','N',None, None, 'File',1,'Identifier',None, 'Source to key driver file',),
('ODBCDriver','Component_','N',None, None, 'Component',1,'Identifier',None, 'Source to associated component',),
...
('ODBCDataSource','Component_','N',None, None, 'Component',1,'Identifier',None, 'Source to associated component',),
('ODBCDataSource','Source','N',None, None, None, None, 'Identifier',None, 'Primary key, non-localized.internal token for data source',),
('ODBCDataSource','DriverDescription','N',None, None, None, None, 'Text',None, 'Source to driver description, may be existing driver',),
...
('ODBCSourceAttribute','DataSource_','N',None, None, 'ODBCDataSource',1,'Identifier',None, 'Source to ODBC data source in ODBCDataSource table',),
('ODBCTranslator','Description','N',None, None, None, None, 'Text',None, 'Text used as registered name for translator',),
('ODBCTranslator','File_','N',None, None, 'File',1,'Identifier',None, 'Source to key translator file',),
('ODBCTranslator','Component_','N',None, None, 'Component',1,'Identifier',None, 'Source to associated component',),
