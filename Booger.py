    ...
    def show( self ) -> str:
        try:
            ...
            layout = [ [ sg.Text( size = space ), sg.Text( size = space ) ],
                       ...
                       [ sg.Text( size = space ), sg.OK( size = btnsize ), sg.Text( size = (8, 1) ),
    ...
    def show( self ) -> str:
        try:
            ...
            layout = [ [ sg.Text( '', size = space ), sg.Text( r'', size = line ) ],
                       ...
                       [ sg.Text( '', size = space ),
                         sg.Listbox( names, size = lstsz, key = '-ITEM-', font = self.__themefont ) ],
                       [ sg.Text( '', size = space ), sg.Text( r'', size = line ) ],
                       [ sg.Text( '', size = space ), sg.Button( 'Select', size = btnsize, enable_events = True ),
                ...
                for rows in range( len( color_list ) // COLORS_PER_ROW + 1 ):
                    ...
                    for i in range( COLORS_PER_ROW ):
                        try:
                            ...
                            row.append( sg.Text( ' ', s = 1, background_color = color, text_color = color,
                                                 font = self.__themefont,
