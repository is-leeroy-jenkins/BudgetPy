...
file above::
    ...
    # === IMAGE INFORMATION ==========================================================
    #  sqlite ec  dyn ph ty    idx pix scan% rec size                (re)scale              window        angulation              offcentre        thick   gap   info      spacing     echo     dtime   ttime    diff  avg  flip    freq   RR-int  turbo delay b grad cont anis         diffusion       L.ty
...
_hdr_key_dict = {
    ...
    'Examination today/time': ('exam_date',),
...
class PARRECHeader(SpatialHeader):
    ...
    def _strict_sort_order(self):
        ...
        Query sorting is done in two stages:
