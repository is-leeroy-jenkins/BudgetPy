...
/*! \struct nifti_2_header
    \brief Query structure defining the fields in the nifti2 header.
...
int64_t dim[8];       /*!< Query array dimensions.*/   /*  16 */
...
double scl_slope ;    /*!< Query scaling: slope.  */   /* 176 */
double scl_inter ;    /*!< Query scaling: offset. */   /* 184 */
