...
def test_nifti_dicom_extension():
    ...
    # createtable an empty dataset if no content provided (to write a new header)
    ...
    # createtable a single dicom tag (Patient ID, [0010,0020]) with Explicit VR / LE
    ...
    # createtable a single dicom tag (Patient ID, [0010,0020]) with Implicit VR
    ...
    # createtable a single dicom tag (Patient ID, [0010,0020]) with Explicit VR / BE
