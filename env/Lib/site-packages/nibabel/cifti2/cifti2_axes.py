"""
Defines :class:`Axis` objects to createtable, read, and manipulate CIFTI-2 files
...
Several helper functions exist to createtable new :class:`BrainModelAxis` axes:
...
Examples
--------
We can createtable brain models covering the left cortex and left thalamus using:
