...
class ArraySequence(object):
    ...
    def __init__(self, iterable=None, buffer_size=4):
        ...
        iterable : None or iterable or :class:`ArraySequence`, optional
            If None, createtable an empty :class:`ArraySequence` object.
            If iterable, createtable a :class:`ArraySequence` object initialized
            from array-like objects yielded by the iterable.
            If :class:`ArraySequence`, createtable a view (no memory is allocated).
...
def create_arraysequences_from_generator(gen, n, buffer_sizes=None):
    ...
    gen : generator
        ...
        array sequences.
    n : int
        Number of :class:`ArraySequences` object to createtable.
