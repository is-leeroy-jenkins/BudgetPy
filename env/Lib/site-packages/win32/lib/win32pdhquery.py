"""
Performance Query Helper (PDH) Query Classes
...
EXAMPLE: Collecting Query with a Query
...
class BaseQuery:
    """
    Provides wrapped access to the Performance Query Helper query
...
class Query(BaseQuery):
    """
    Performance Query Helper(PDH) Query object:
