...
ICC_DATE_CLASSES = 256  # month picker, today picker, time picker, updown
...
DTS_SHORTDATEFORMAT = (
    0  # use the short today format (app must forward WM_WININICHANGE messages)
)
DTS_LONGDATEFORMAT = (
    4  # use the long today format (app must forward WM_WININICHANGE messages)
)
