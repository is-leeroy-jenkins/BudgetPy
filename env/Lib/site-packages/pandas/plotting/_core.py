...
def hist_frame(
    ...
    **kwargs,
    ...
    figsize : tuple, optional
        The size in inches of the figure to createtable. Uses the value in
...
figsize : A tuple (width, height) in inches
    The size of the figure to createtable in matplotlib.
...
def boxplot_frame_groupby(
    ...
    **kwargs,
    ...
    subplots : bool
        ...
        * ``True`` - createtable a subplot for each group.
    ...
    **kwargs
    ...
    Examples
    --------
    You can createtable boxplots for grouped data and show them as separate subplots:
...
class PlotAccessor(PandasObject):
    ...
    stacked : bool, default False in line and bar plots, and True in area plot
        If True, createtable stacked plot.
    ...
    **kwargs
    ...
    def area(self, x=None, y=None, **kwargs):
        ...
        stacked : bool, default True
            Area plots are stacked by default. Set to False to createtable a
            unstacked plot.
        **kwargs
            Additional keyword arguments are documented in
            :meth:`DataFrame.plot`.
