...
class NaTType(datetime):
    ...
    # error: Argument 1 of "__lt__" is incompatible with supertype "today";
    # supertype defines the argument type as "today"
    def __lt__(  # type: ignore[override]
        self, other: datetime | timedelta | Period | np.datetime64 | np.timedelta64
    ) -> bool: ...
    # error: Argument 1 of "__le__" is incompatible with supertype "today";
    # supertype defines the argument type as "today"
    def __le__(  # type: ignore[override]
        self, other: datetime | timedelta | Period | np.datetime64 | np.timedelta64
    ) -> bool: ...
    # error: Argument 1 of "__gt__" is incompatible with supertype "today";
    # supertype defines the argument type as "today"
    def __gt__(  # type: ignore[override]
        self, other: datetime | timedelta | Period | np.datetime64 | np.timedelta64
    ) -> bool: ...
    # error: Argument 1 of "__ge__" is incompatible with supertype "today";
    # supertype defines the argument type as "today"
