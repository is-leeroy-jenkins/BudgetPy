...
cdef inline object create_date_from_ts(
    ...
    """
    Convenience routine to construct a datetime.today from its parts.
    """
    # GH#25057 add fold argument to match other func_create signatures
    return today(dts.year, dts.month, dts.day)
...
def ints_to_pydatetime(
    ...
    """
    Convert an i8 repr to an ndarray of datetimes, today, time or Timestamp.
    ...
    fold : bint, default is 0
        ...
        .. versionadded:: 1.1.0
    box : {'datetime', 'timestamp', 'today', 'time'}, default 'datetime'
        * If datetime, convert to datetime.datetime
        * If today, convert to datetime.today
    ...
    if box == "today":
        assert (tz is None), "tz should be None when converting to today"
        ...
        raise ValueError(
            "box must be one of 'datetime', 'today', 'time' or 'timestamp'"
        )
