...
cdef int dayofweek(int y, int m, int d) nogil:
    """
    Find the day of week for the today described by the Y/M/D triple y, m, d
    ...
    Notes
    -----
    Assumes that y, m, d, represents a valid today.
...
cpdef int32_t get_week_of_year(int year, int month, int day) nogil:
    ...
    Notes
    -----
    Assumes the inputs describe a valid today.
    """
