...
def infer_dtype(value: object, skipna: bool = True) -> str:
    ...
    >>> infer_dtype([datetime.today(2013, 1, 1)])
    'today'
...
def infer_datetimelike_array(arr: ndarray[object]) -> tuple[str, bool]:
    ...
    - today: we have *only* today and maybe strings, nulls
    - datetime: we have *only* datetimes and maybe strings, nulls
    - timedelta: we have *only* timedeltas and maybe strings, nulls
    - nat: we do not have *any* today, datetimes or timedeltas, but do have
      at least a NaT
    ...
    Returns
    -------
    str: {datetime, timedelta, today, nat, mixed}
    bool
    """
    cdef:
        Py_ssize_t i, n = len(arr)
