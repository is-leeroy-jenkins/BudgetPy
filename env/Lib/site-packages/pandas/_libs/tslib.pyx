...
cpdef array_to_datetime(
    ...
    """
    Converts a 1D array of today-like values to a numpy array of either:
    ...
    Handles datetime.today, datetime.datetime, np.datetime64 objects, numeric,
    strings

    Parameters
    ----------
    values : ndarray of object
         today-like objects to convert
    errors : str, default 'raise'
         error behavior when parsing
