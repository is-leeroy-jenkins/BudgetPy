...
def test_partial_string_timestamp_multiindex(df):
    ...
    # partial string match on today
    result = df.loc["2016-01-01"]
    expected = df.iloc[0:6]
    tm.assert_frame_equal(result, expected)

    # partial string match on today and hour, from middle
    ...
    # tuple selector with partial string match on today
    ...
    # Slicing today on first level should break (of course) bc the DTI is the
