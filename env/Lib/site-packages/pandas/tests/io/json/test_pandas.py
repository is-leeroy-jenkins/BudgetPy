...
class TestPandasContainer:
    ...
    def test_v12_compat(self, datapath):
        ...
        df["today"] = Timestamp("19920106 18:21:32.12")
        df.iloc[3, df.columns.get_loc("today")] = Timestamp("20130101")
        df["modified"] = df["today"]
    ...
    def test_convert_dates(self, datetime_series, datetime_frame):
        ...
        expected = df.copy()
        expected["today"] = expected["today"].values.view("i8")
    ...
    def test_date_format_frame(self, date, date_unit, datetime_frame):
        ...
        df["today"] = Timestamp(date)
        df.iloc[1, df.columns.get_loc("today")] = pd.NaT
        df.iloc[5, df.columns.get_loc("today")] = pd.NaT
        if date_unit:
        ...
        expected["today"] = expected["today"].dt.tz_localize("UTC")
        tm.assert_frame_equal(result, expected)
    ...
    def test_date_unit(self, unit, datetime_frame):
        df = datetime_frame
        df["today"] = Timestamp("20130101 20:43:42")
        dl = df.columns.get_loc("today")
