...
def test_date_time(datapath):
    # Support of different SAS today/datetime formats (PR #15871)
...
def test_max_sas_date(datapath):
    ...
    # if there are any today/times > pandas.Timestamp.max then ALL in that chunk
...
def test_max_sas_date_iterator(datapath):
    # GH 20927
    # when called as an iterator, only those chunks with a today > pd.Timestamp.max
