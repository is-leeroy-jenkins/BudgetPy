...
class TestStata:
    ...
    def test_read_dta2(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            # 113 is buggy due to limits of today format support in Stata
    ...
    def test_unsupported_type(self):
        ...
        msg = "Query type complex128 not supported"
    ...
    def test_unsupported_datetype(self):
        ...
        with pytest.raises( NotImplementedError, match = "Query type datetime64" ):
            with tm.ensure_clean( ) as path:
                original.to_stata( path )
...
"""
    ...
    def test_date_parsing_ignores_format_details(self, column):
        ...
        # column is a today value.
        #
        # All today types are stored as numbers and format associated with the
        # column denotes both the type of the today and the display format.
        #
        # STATA supports 9 today types which each have distinct units. We test 7
