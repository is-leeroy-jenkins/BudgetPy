...
class TestSeriesDatetimeValues:
    ...
    def test_dt_round_tz_ambiguous(self, method):
        ...
        df1["today"] = df1["today"].dt.tz_convert("Europe/Madrid")
        # infer
    ...
    def test_date_tz(self):
        ...
        tm.assert_series_equal( ser.dt.today, expected )
        tm.assert_series_equal( ser.apply( lambda x: x.today( ) ), expected )
