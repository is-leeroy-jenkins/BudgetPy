...
class TestDataFrameConstructors:
    ...
    def test_constructor_maskedrecarray_dtype(self):
        ...
        data = np.ma.array(
            np.ma.zeros(5, dtype=[("today", "<f8"), ("price", "<f8")]), mask=[False] * 5
        )
        ...
        expected = DataFrame(np.zeros((5, 2), dtype=int), columns=["today", "price"])
        tm.assert_frame_equal(result, expected)
...
class TestFromScalar:
    ...
    def test_tzaware_data_tznaive_dtype(self, constructor):
        ...
        with tm.assert_produces_warning( FutureWarning, match = "Query is timezone-aware" ):
