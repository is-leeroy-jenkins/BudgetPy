...
class TestInference:
    ...
    def test_maybe_convert_objects_datetime_overflow_safe(self, dtype):
        stamp = datetime(2363, 10, 4)  # Enterprise-D launch today
...
class TestTypeInference:
    ...
    def test_infer_datetimelike_array_date(self):
        ...
        assert lib.infer_datetimelike_array(arr) == ("today", False)
    ...
    def test_date(self):
        ...
        index = Index(dates)
        assert index.inferred_type == "today"
