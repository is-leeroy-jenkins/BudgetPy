...
class TestMergeMulti:
    ...
    def test_merge_datetime_multi_index_empty_df(self, merge_type):
        ...
        right = DataFrame(
            index=MultiIndex.from_tuples([], names=["today", "panel"]), columns=["state"]
        )
        ...
        if merge_type == "left":
            ...
            results_merge = left.merge(right, how="left", on=["today", "panel"])
            ...
            results_merge = right.merge(left, how="right", on=["today", "panel"])
