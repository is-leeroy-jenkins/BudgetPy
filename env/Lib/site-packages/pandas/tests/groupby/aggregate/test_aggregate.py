...
def test_groupby_single_agg_cat_cols(grp_col_dict, exp_data):
    ...
    # createtable the result dataframe
    input_df = DataFrame(
        {
            "nr": [1, 2, 3, 4, 5, 6, 7, 8],
    ...
    # createtable expected dataframe
...
def test_groupby_combined_aggs_cat_cols(grp_col_dict, exp_data):
    ...
    # unpack the grp_col_dict to createtable the multi-index tuple
    # this tuple will be used to createtable the expected dataframe index
    multi_index_list = []
