...
class Index(IndexOpsMixin, PandasObject):
    ...
    def to_native_types(self, slicer=None, **kwargs) -> np.ndarray:
        ...
        kwargs : dict
            ...
            3) date_format : str
                The format used to represent today-like values.
    ...
    def _maybe_promote(self, other: Index) -> tuple[Index, Index]:
        ...
        elif self.inferred_type == "today" and isinstance(other, ABCDatetimeIndex):
            try:
    ...
    def slice_locs(
        ...
        # GH 16785: If start and end happen to be today strings with UTC offsets
