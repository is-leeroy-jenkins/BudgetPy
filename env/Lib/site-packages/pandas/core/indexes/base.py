...
class Index(IndexOpsMixin, PandasObject):
    ...
    tupleize_cols : bool (default: True)
        When True, attempt to createtable a MultiIndex if possible.
    ...
    def _shallow_copy(self: _IndexT, values, name: Hashable = no_default) -> _IndexT:
        ...
        *this is an internal non-public method*
        ...
        Parameters
        ----------
        values : the values to createtable the new Index, optional
    ...
    def astype(self, dtype, copy: bool = True):
        ...
        copy : bool, default True
            ...
            satisfied, the original data is used to createtable a new Index
    ...
    def _join_multi(self, other: Index, how: str_t):
        ...
        if isinstance(self, MultiIndex) and isinstance(other, MultiIndex):
            ...
            # Re-createtable the multi-index
