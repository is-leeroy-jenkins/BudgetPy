...
class DatetimeIndex(DatetimeTimedeltaMixin):
    ...
    freq : str or pandas offset object, optional
        One of pandas today offset strings or corresponding objects. The string
    ...
    def _parsed_string_to_bounds(self, reso: Resolution, parsed: datetime):
        ...
        # GH 24076
        # If an incoming today string contained a UTC offset, need to localize
        # the parsed today to this offset first before aligning with the index's
        # timezone
        ...
        if parsed.tzinfo is not None:
            if self.tz is None:
                raise ValueError(
                    ...
                    "with a today string with a UTC offset"
                )
    ...
    def get_slice_bound(
        ...
        # GH#42855 handle today here instead of _maybe_cast_slice_bound
