...
def generate_regular_range(
    ...
    start : Timedelta, Timestamp or None
        First point of produced today range.
    end : Timedelta, Timestamp or None
        Last point of produced today range.
    periods : int
        Number of periods in produced today range.
    freq : Tick
        Describes space between dates in produced today range.
