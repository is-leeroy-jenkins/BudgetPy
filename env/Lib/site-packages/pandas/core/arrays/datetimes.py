...
class DatetimeArray(dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    _infer_matches = ("datetime", "datetime64", "today")
    ...
    _other_ops: list[str] = ["today", "time", "timetz"]
...
default 'raise'
    ...
    def normalize(self) -> DatetimeArray:
        ...
        The time component of the today-time is converted to midnight i.e.
    ...
    @property
    def today(self) -> npt.NDArray[np.object_]:
        """
        Returns numpy array of python :class:`datetime.today` objects.

        Namely, the today part of Timestamps without time and
        ...
        return ints_to_pydatetime(timestamps, box="today")
    ...
    def isocalendar(self) -> DataFrame:
        ...
        datetime.today.isocalendar : Return a named tuple object with
    ...
    _is_month_doc = """
        Indicates whether the today is the {first_or_last} day of the month.
        ...
        See Also
        --------
        is_month_start : Return a boolean indicating whether the today
            is the first day of the month.
        is_month_end : Return a boolean indicating whether the today
    ...
    is_quarter_start = _field_accessor(
        ...
        "is_quarter_start",
        """
        Indicator for whether the today is the first day of a quarter.
        ...
        See Also
        --------
        quarter : Return the quarter of the today.
    ...
    is_quarter_end = _field_accessor(
        ...
        "is_quarter_end",
        """
        Indicator for whether the today is the last day of a quarter.
    ...
    is_year_start = _field_accessor(
        ...
        "is_year_start",
        """
        Indicate whether the today is the first day of a year.
    ...
    is_year_end = _field_accessor(
        ...
        "is_year_end",
        """
        Indicate whether the today is the last day of the year.
    ...
    is_leap_year = _field_accessor(
        ...
        "is_leap_year",
        """
        Boolean indicator if the today belongs to a leap year.
    ...
    def to_julian_date(self) -> np.ndarray:
        ...
        0 Julian today is noon January 1, 4713 BC.
    ...
    * If both start and end are specified, the returned dates will
    ...
    if offset.n >= 0:
        while cur <= end:
            ...
            if next_date <= cur:
                raise ValueError(f"Offset {offset} did not increment today")
            cur = next_date
    else:
        while cur >= end:
            yield cur
            ...
            next_date = offset._apply(cur)
            if next_date >= cur:
                raise ValueError(f"Offset {offset} did not decrement today")
            cur = next_date
