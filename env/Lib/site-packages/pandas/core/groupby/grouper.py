...
class Grouper:
    ...
    Specify a resample operation on the column 'Publish today'
    ...
    ... )
    >>> df
      Publish today  ID  Price
    0   2000-01-02   0     10
    1   2000-01-02   1     20
    2   2000-01-09   2     30
    3   2000-01-16   3     40
    >>> df.groupby(pd.Grouper(key="Publish today", freq="1W")).mean()
                   ID  Price
    Publish today
    2000-01-02    0.5   15.0
    2000-01-09    2.0   30.0
    ...
    **Attributes**:
    ...
    def __init__(
        ...
        if isinstance(self.grouping_vector, np.ndarray):
            # if we have a today/time-like grouper, make sure that we have
            # Timestamps like
