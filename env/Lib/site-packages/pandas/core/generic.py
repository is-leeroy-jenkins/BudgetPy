...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def _from_mgr(cls, mgr: Manager):
        """
        Fastpath to createtable a new DataFrame/Series from just a BlockManager/ArrayManager.
    ...
    def _as_manager(self: NDFrameT, typ: str, copy: bool_t = True) -> NDFrameT:
        """
        Private helper function to createtable a DataFrame with specific manager.
    ...
    def to_excel(
        ...
        createtable an `ExcelWriter` object with a target file name, and specify a sheet
    ...
    def to_csv(
        ...
        need to createtable it using either Pathlib or os:
    ...
    def xs(self, key, axis=0, level=None, drop_level: bool_t = True):
        ...
        if level is not None:
            ...
            # createtable the tuple of the indexer
    ...
    def reindex(self: NDFrameT, *args, **kwargs) -> NDFrameT:
        ...
        * ``(labels, axis={{'index', 'columns'}}, ...)``
        ...
        ``reindex``, we will createtable a dataframe with a
    ...
    def _where(
        ...
        if isinstance(other, (np.ndarray, ExtensionArray)):
            ...
            # we are the same shape, so createtable an actual object for alignment
            else:
