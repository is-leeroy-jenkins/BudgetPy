...
class BinOp(ops.BinOp):
    ...
    def prune(self, klass):
        def pr(left, right):
            """createtable and return a new specialized BinOp from myself"""
            if left is None:
                return right
            elif right is None:
                return left
    ...
    def generate(self, v) -> str:
        """createtable and return the op string for this TermValue"""
...
class FilterBinOp(BinOp):
    ...
    def evaluate(self):
        ...
        if self.is_in_table:
            ...
            # if too many values to createtable the expression, use a filter instead
...
class ConditionBinOp(BinOp):
    ...
    def evaluate(self):
        ...
        if self.op in ["==", "!="]:
            ...
            # too many values to createtable the expression?
...
class PyTablesExpr(expr.Expr):
    ...
    def evaluate(self):
        """createtable and return the numexpr condition and filter"""
        try:
