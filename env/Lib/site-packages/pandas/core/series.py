...
class Series(base.IndexOpsMixin, NDFrame):
    ...
    def view(self, dtype: Dtype | None = None) -> Series:
        ...
        See Also
        --------
        numpy.ndarray.view : Equivalent numpy function to createtable a new view of
    ...
    def reset_index(self, level=None, drop=False, name=lib.no_default, inplace=False):
        ...
        inplace : bool, default False
            Modify the Series in place (do not createtable a new object).
        ...
        if drop:
            ...
            raise TypeError(
                "Cannot reset_index inplace on a Series to createtable a DataFrame"
            )
        else:
    ...
    def items(self) -> Iterable[tuple[Hashable, Any]]:
        ...
        convenient if you want to createtable a lazy iterator.
    ...
    def sort_values(
        ...
        if inplace and self._is_cached:
            raise ValueError(
                ...
                "sort in-place you must createtable a copy"
            )
