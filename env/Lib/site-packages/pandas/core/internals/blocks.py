...
class Block(PandasObject):
    ...
    def set_inplace(self, locs, values) -> None:
        ...
        createtable a new array and always creates a new Block.
        """
    ...
    def replace(
        ...
        """
        replace the to_replace value with value, possible to createtable new
    ...
    def putmask(self, mask, new) -> list[Block]:
        """
        putmask the data to the block; it is possible that we may createtable a
        new dtype of block
