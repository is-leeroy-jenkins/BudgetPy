...
class BaseArrayManager(DataManager):
    ...
    def apply(
        ...
        **kwargs,
        ...
        """
        Iterate over the arrays, collect and createtable a new ArrayManager.
    ...
    def reduce(
        ...
        for i, arr in enumerate(self.arrays):
            try:
                ...
                # TODO NaT doesn't preserve dtype, so we need to ensure to createtable
...
class NullArrayProxy:
    ...
    def to_array(self, dtype: DtypeObj) -> ArrayLike:
        """
        Helper function to createtable the actual all-NA array from the NullArrayProxy
        object.
