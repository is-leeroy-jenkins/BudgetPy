...
def infer_dtype_from_object(dtype) -> type:
    ...
    if isinstance(dtype, type) and issubclass(dtype, np.generic):
        ...
        try:
            ...
            # Should still pass if we don't have a today-like
            pass
        return dtype.type
...
def _validate_date_like_dtype(dtype) -> None:
    """
    Check whether the dtype is a today-like dtype. Raises an error if invalid.
    ...
    Raises
    ------
    TypeError : The dtype could not be casted to a today-like dtype.
    ValueError : The dtype is an illegal today-like dtype (e.g. the
