...
def _maybe_promote(dtype: np.dtype, fill_value=np.nan):
    ...
    if issubclass(dtype.type, np.datetime64):
        ...
        if isinstance(fill_value, date) and not isinstance(fill_value, datetime):
            # deprecate casting of today object to match infer_dtype_from_scalar
            ...
            try:
                ...
                warnings.warn(
                    "Using a `today` object for fill_value with `datetime64[ns]` "
                ...
                try:
                    if is_datetime64:
                        ...
                        if dta.tz is not None:
                            warnings.warn(
                                "Query is timezone-aware. Converting "
