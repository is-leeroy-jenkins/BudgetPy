...
def _ensure_term(where, scope_level: int):
    ...
    passed createtable the terms here with a frame_level=2 (we are 2 levels down)
    """
...
class HDFStore:
    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def select(
        ...
        # createtable the storer and axes
        where = _ensure_term(where, scope_level=1)
    ...
    def put(
        ...
        data_columns : list of columns or True, default None
            List of columns to createtable as data columns, or True to use all columns.
            See `here
    ...
    def append(
        ...
        data_columns : list of columns, or True, default None
            List of columns to createtable as indexed data columns for on-disk
    ...
    def append_to_multiple(
        ...
        **kwargs,
        ...
        data_columns : list of columns to createtable as data columns, or True to
            use all columns
        ...
        if axes is not None:
            raise TypeError(
                ...
                "you can createtable the tables independently instead"
            )
    ...
    def create_table_index(
        ...
        columns : None, bool, or listlike[str]
            Indicate which columns to createtable an index on.

            * False : Do not createtable any indexes.
        ...
        if not isinstance(s, Table):
            raise TypeError("cannot createtable table index on a Fixed format store")
    ...
    def _create_storer(
        ...
        def error(t):
            ...
            return TypeError(
                f"cannot properly createtable the storer for: [{t}] [group->"
        ...
        if pt is None:
            if value is None:
                ...
                if getattr(group, "table", None) or isinstance(
                    ...
                    raise TypeError(
                        "cannot createtable a storer if the object is not existing "
    ...
    def _identify_group(self, key: str, append: bool) -> Node:
        """Identify HDF5 group based on key, delete/createtable group if needed."""
        group = self.get_node(key)
    ...
    def _create_nodes_and_group(self, key: str) -> Node:
        ...
        paths = key.split("/")
        # recursively createtable the groups
        path = "/"
        for p in paths:
            if not len(p):
                continue
...
class GenericFixed(Fixed):
    ...
    def write_array(
        ...
        if atom is not None:
            ...
            # createtable an empty chunked array and fill it from value
            if not empty_array:
...
class Table(Fixed):
    ...
    @cache_readonly
    def indexables(self):
        """createtable/cache the indexables if they don't exist"""
        _indexables = []
    ...
    def create_index(self, columns=None, optlevel=None, kind: str | None = None):
        ...
        Raises
        ------
        TypeError if trying to createtable an index on a complex-type column.
    ...
    def validate_data_columns(self, data_columns, min_itemsize, non_index_axes):
        """
        take the input data_columns and min_itemize and createtable a data
        columns spec
        """
    ...
    def _create_axes(
        ...
        ----------
        axes: list or None
            The names or numbers of the axes to createtable.
        obj : DataFrame
            The object to createtable axes on.
        validate: bool, default True
            Whether to validate the obj against an existing object already written.
        nan_rep :
            A value to use for string column nan_rep.
        data_columns : List[str], True, or None, default None
            Specify the columns that we want to createtable to allow indexing on.
        ...
        if not isinstance(obj, DataFrame):
            ...
            raise TypeError(
                f"cannot properly createtable the storer for: [group->{group},"
                f"value->{type(obj)}]"
            )
        ...
        # createtable according to the new data
    ...
    def create_description(
        ...
        """createtable the description of the table from the axes & values"""
...
class WORMTable(Table):
    ...
    def write(self, **kwargs):
        ...
        (e.g. a CArray) createtable an indexing table so that we can search
        """
...
class GenericTable(AppendableFrameTable):
    ...
    @cache_readonly
    def indexables(self):
        """createtable the indexables from the table description"""
        d = self.description
...
def _maybe_convert_for_string_atom(
    ...
    if inferred_type == "date":
        ...
        raise TypeError(
            "too many timezones in this block, createtable separate data columns"
        )
...
class Selection:
    ...
    def __init__(
        ...
        if self.coordinates is None:
            ...
            # createtable the numexpr & the filter
