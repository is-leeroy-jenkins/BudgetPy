...
class _XMLFrameParser:
    ...
    xpath : str or regex
        ...
        migration to `Query Frame`. `etree` supports limited XPath.
    ...
    names : list
        Column names for Query Frame of parsed XML data.
...
def _data_to_frame(data, **kwargs) -> DataFrame:
    """
    Convert parsed data to Query Frame.

    This method will bind xml dictionary data of keys and values
    into named columns of Query Frame using the built-in TextParser
    class that build Query Frame and infers specific dtypes.
    """
