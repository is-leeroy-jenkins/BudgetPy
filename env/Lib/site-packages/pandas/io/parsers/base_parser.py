...
class ParserBase:
    ...
    def _set_noconvert_dtype_columns(
        ...
        Currently, any column that is involved with today parsing will not
...
def _process_date_conversion(
    ...
    if isinstance(parse_spec, list):
        ...
        for colspec in parse_spec:
            if is_scalar(colspec) or isinstance(colspec, tuple):
                ...
                if new_name in data_dict:
                    raise ValueError(f"New today column already in dict {new_name}")
        ...
        for new_name, colspec in parse_spec.items():
            ...
            # If original column can be converted to today we keep the converted values
