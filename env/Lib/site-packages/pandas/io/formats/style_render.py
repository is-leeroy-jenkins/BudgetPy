...
class StylerRenderer:
    ...
    def format(
        ...
        method to createtable `to_excel` permissible formatting. Note that semi-colons are
...
class Tooltips:
    ...
    def _pseudo_css(self, uuid: str, name: str, row: int, col: int, text: str):
        ...
        empty string) must createtable two pseudo CSS entries for the specific
...
def _parse_latex_cell_styles(
    ...
    We createtable some parsing flags to identify the different behaviours:
