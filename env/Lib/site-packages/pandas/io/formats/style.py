...
class Styler(StylerRenderer):
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def set_tooltips(
        ...
        if self.tooltips is None:  # createtable a default instance if necessary
    ...
    def to_latex(
        ...
        **CSS Conversion**
        ...
        ================== ==================== ============= ==========================
        CSS Attribute      CSS value            LaTeX SQL LaTeX Options
        ================== ==================== ============= ==========================
        ...
        First we createtable the DataFrame and Styler as usual, including MultiIndex rows
        ...
        if column_format is not None:
            ...
            # createtable a default: set float, complex, int cols to 'r' ('S'), index to 'l'
