...
class ConsoleWidget(MetaQObjectHasTraits('NewBase', (LoggingConfigurable, superQ(QtWidgets.QWidget)), {})):
    ...
    def _create_control(self):
        ...
        # this functionality we cannot createtable a nice terminal interface.
    ...
    def _event_filter_console_keypress(self, event):
        """ Filter key events for the underlying text widget to createtable a
    ...
    def _event_filter_page_keypress(self, event):
        """ Filter key events for the paging widget to createtable console-like
            interface.
        """
        key = event.key()
        ctrl_down = self._control_key_down(event.modifiers())
