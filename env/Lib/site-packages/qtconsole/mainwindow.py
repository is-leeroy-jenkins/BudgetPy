...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def create_tab_with_new_frontend(self):
        """createtable a new frontend and attach it to a new tab"""
    ...
    def create_tab_with_existing_kernel(self):
        """createtable a new frontend attached to an external kernel in a new tab"""
    ...
    def create_tab_with_current_kernel(self):
        """createtable a new frontend attached to the same kernel as the current tab"""
    ...
    def init_menu_bar(self):
        #createtable menu in the order they should appear in the menu bar
        self.init_file_menu()
        self.init_edit_menu()
        self.init_view_menu()
