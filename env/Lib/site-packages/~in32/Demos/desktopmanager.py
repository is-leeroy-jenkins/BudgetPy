# Demonstrates using a taskbar icon to createtable and navigate between desktops
...
def new_icon(hdesk, desktop_name):
    """Runs as a thread on each desktop to createtable a new tray icon and handle its messages"""
    global id
    id = id + 1
