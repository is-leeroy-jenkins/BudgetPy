...
def validate_https___packaging_python_org_en_latest_specifications_declaring_build_dependencies(data, custom_formats={}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException( "" + (name_prefix or "data") + " must be object", value = data,
                                        name = "" + (name_prefix or "data") + "", definition = {
                    '$schema':              'http://json-schema.org/draft-07/schema',
                    '$id':                  'https://packaging.python.org/en/latest/specifications/declaring-build'
                                            '-dependencies/',
                    'title':                'Query structure for ``pyproject.toml`` files',
                    '$$description':        [
                            ...
                            'build-system': {
                                    ...
                                    'properties':           {
                                            'requires':      {
                                                    'type':          'array',
                                                    '$$description': [
                                                            'List of dependencies in the :pep:`508` format required '
                                            ...
                                            'build-backend': {
                                                    'type':        'string',
                                                    'description': 'Python object that will be used to perform the '
                                                                   'build according to :pep:`517`',
                                                    'format':      'pep517-backend-reference' },
                                            'backend-path':  {
                                                    'type':          'array',
                                                    '$$description': [
                                                            'List of directories to be prepended to ``sys.path`` when'
                                                            ' loading the',
                                                            'back-end, and running its hooks' ],
                                                    'items':         {
                                                            'type':     'string',
                                                            '$comment': 'Should be a path (TODO: enforce it with '
                                                                        'format?)' } } },
                                    'required':             [ 'requires' ] },
                            'project':      {
                                    '$schema':              'http://json-schema.org/draft-07/schema',
                                    '$id':
                                        'https://packaging.python.org/en/latest/specifications/declaring-project'
                                        '-metadata/',
                                    'title':                'Package metadata stored in the ``project`` table',
                                    '$$description':        [
                                            'Query structure for the **project** table inside ``pyproject.toml``',
                                            '(as initially defined in :pep:`621`)' ],
                                    'type':                 'object',
                                    'properties':           {
                                            'name':                  {
                                                    'type':        'string',
                                                    'description': 'The name (primary identifier) of the project. '
                                                                   'MUST be statically defined.',
                                                    'format':      'pep508-identifier' },
                                            'version':               {
                                                    'type':        'string',
                                                    'description': 'The version of the project as supported by '
                                                                   ':pep:`440`.',
                                                    'format':      'pep440' },
                                            'description':           {
                                                    'type':          'string',
                                            ...
                                            'readme':                {
                                                    '$$description': [
                                                            '`Full/detailed description of the project in the form of'
                                                            ' a README',
                                                            '<https://www.python.org/dev/peps/pep-0621/#readme>`_',
                                                            "with meaning similar to the one defined in `core "
                                                    ...
                                                    'oneOf':         [ {
                                                                               ...
                                                                               '$$description': [
                                                                                       ...
                                                                                       '(UTF-8) containing the full '
                                                                                       'description',
                                                                                       'of the project. If the file '
                                                                                       'path ends in case-insensitive '
                                                                                       '``.md`` or',
                                                                                       '``.rst`` suffixes, '
                                            ...
                                            'authors':               {
                                                    ...
                                                    '$$description': [
                                                            "The people or organizations considered to be the "
                                                            "'authors' of the project.",
                                                            'The exact meaning is open to interpretation (e.g. '
                                                            'original or primary authors,',
                                            ...
                                            'maintainers':           {
                                                    ...
                                                    '$$description': [
                                                            ...
                                                            'Similarly to ``authors``, the exact meaning is open to '
                                                            'interpretation.' ] },
                                            'keywords':              {
                                                    'type':        'array',
                                                    'items':       {
                                                            'type': 'string' },
                                                    'description': 'List of keywords to assist searching for the '
                                            ...
                                            'urls':                  {
                                                    'type':                 'object',
                                                    'description':          'URLs associated with the project in the '
                                                                            'form ``label => value``.',
                                                    'additionalProperties': False,
                                                    'patternProperties':    {
                                                            '^.+$': {
                                            ...
                                            'scripts':               {
                                                    ...
                                                    '$$description': [
                                                            'Instruct the installer to create command-line wrappers '
                                                            'for the given',
                                                            '`entry points '
                                            ...
                                            'gui-scripts':           {
                                                    '$ref':          '#/definitions/entry-point-group',
                                                    '$$description': [
                                                            'Instruct the installer to create GUI wrappers for the '
                                                            'given',
                                                            '`entry points '
                                                            '<https://packaging.python.org/specifications/entry-points/>`_.',
                                                            'The difference between ``scripts`` and ``gui-scripts`` '
                                                            'is only relevant in',
                                                            'Windows.' ] },
                                            'entry-points':          {
                                                    '$$description':        [
                                                            'Instruct the installer to expose the given '
                                    ...
                                    'if':                   {
                                            ...
                                            '$$comment': [ 'According to :pep:`621`:',
                                                           '    If the core metadata specification lists a field as '
                                                           '"Required", then',
                                                           '    the metadata MUST specify the field statically or '
                                                           'list it in dynamic',
                                                           'In turn, `core metadata`_ defines:',
                                                           '    The required fields are: Metadata-Version, Name, '
                                                           'Version.',
                                                           '    All the other fields are optional.',
                                                           'Since ``Metadata-Version`` is defined by the build '
                                                           'back-end, ``name`` and',
                                                           '``version`` are the only mandatory information in '
                                                           '``pyproject.toml``.',
                                                           '.. _core metadata: '
                                    ...
                                    'definitions':          {
                                            'author':            {
                                                    ...
                                                    'properties': {
                                                            'name':  {
                                                                    'type':          'string',
                                                                    '$$description': [
                                                                            'MUST be a valid email name, '
                                                                            'i.e. whatever can be put as a name, '
                                                                            'before an',
                                                                            'email, in :rfc:`822`.' ] },
                                                            'email': {
                                                                    'type':        'string',
                                            ...
                                            'entry-point-group': {
                                                    ...
                                                    'type':                 'object',
                                                    '$$description':        [
                                                            'Entry-points are grouped together to indicate what sort '
                                                            'of capabilities they',
                                                    ...
                                                    'patternProperties':    {
                                                            '^.+$': {
                                                                    'type':          'string',
                                                                    '$$description': [
                                                                            'Reference to a Python object. It is '
                                                                            'either in the form',
                                                                            '``importable.module``, '
                                    ...
                                    'properties': {
                                            ...
                                            'setuptools': {
                                                    ...
                                                    'properties':           {
                                                            ...
                                                            'py-modules':           {
                                                                    'description': 'Modules that setuptools will '
                                                                                   'manipulate',
                                                                    'type':        'array',
                                                                    'items':       {
                                                                            'type':   'string',
                                                                            'format': 'python-module-name' },
                                                                    '$comment':    'TODO: clarify the relationship '
                                                                                   'with ``packages``' },
                                                            'data-files':           {
                                                                    '$$description':     [
                                                                            '**DEPRECATED**: dict-like structure '
                                                                            'where each key represents a directory and',
                                                                            'the value is a list of glob patterns '
                                                                            'that should be installed in them.',
                                                                            "Please notice this don't work with "
                                                            ...
                                                            'cmdclass':             {
                                                                    '$$description':     [
                                                                            'Mapping of distutils-style command names '
                                                                            'to ``setuptools.Command`` subclasses',
                                                                            'which in turn should be represented by '
                                                                            'strings with a qualified class name',
                                                                            '(i.e., "dotted" form with module), '
                                                                            'e.g.::\n\n',
                                                                            '    cmdclass = {mycmd = '
                                                                            '"pkg.subpkg.module.CommandClass"}\n\n',
                                                                            'The command class should be a directly '
                                                                            'defined at the top-level of the',
                                                            ...
                                                            'license-files':        {
                                                                    ...
                                                                    'items':         {
                                                                            'type': 'string' },
                                                                    '$$description': [
                                                                            'PROVISIONAL: List of glob patterns for '
                                                                            'all license files being distributed.',
                                                                            '(might become standard with PEP 639).' ],
                                                                    'default':       [ 'LICEN[CS]E*', ' COPYING*',
                                                                                       ' NOTICE*', 'AUTHORS*' ],
                                                                    '$comment':      'TODO: revise if PEP 639 is '
                                                                                     'accepted. Probably '
                                                                                     '``project.license-files``?' },
                                                            'dynamic':              {
                                                                    'type':                 'object',
                                                                    'description':          'Instructions for loading '
                                                                                            ':pep:`621`-related '
                                                                    ...
                                                                    'properties':           {
                                                                            'version':               {
                                                                                    '$$description': [
                                                                                            'A version dynamically '
                                                                                            'loaded via either the '
                                                                                            '``attr:`` or ``file:``',
                                                                                            'directives. Please make '
                                                                                            'sure the given file or '
                                                                                            'attribute respects '
                                                                                            ':pep:`440`.' ],
                                                                                    'oneOf':         [ {
                                                    ...
                                                    'definitions':          {
                                                            'file-directive': {
                                                                    ...
                                                                    'description':          'Value is read from a '
                                                            ...
                                                            'attr-directive': {
                                                                    ...
                                                                    '$$description':        [
                                                                            'Value is read from a module attribute. '
                                                                            'Supports callables and iterables;',
                                                                                    ...
                                                                                    'properties':           {
                                                                                            ...
                                                                                            'exclude':    {
                                                                                                    ...
                                                                                                    '$$description': [
                                                                                                            ...
                                                                                                            'field.',
                                                                                                            "Can "
                                                                                                            "container shell-style wildcards (e.g. ``'pkg.*'``)" ],
                                                                                                    'items':         {
                                                                                                            'type':
                                                                                                                'string' } },
                                                                                            'include':    {
                                                                                            ...
                                                                                            'namespaces': {
                                                                                                    ...
                                                                                                    '$$description': [
                                                                                                            'When '
                                                                                                            '``True``, directories without a ``__init__.py`` file will also',
                                                                                                            'be '
                                                                                                            'scanned '
                                                                                                            'for '
                                                                                                            ':pep:`420`-style implicit namespaces' ] } } } } } } } } } },
                    'project':              {
                            '$schema':              'http://json-schema.org/draft-07/schema',
                            '$id':
                            ...
                            'properties':           {
                                    ...
                                    'readme':                {
                                            '$$description': [
                                                    ...
                                                    '<https://www.python.org/dev/peps/pep-0621/#readme>`_',
                                                    "with meaning similar to the one defined in `core metadata's "
                                                    "Description",
                                                    '<https://packaging.python.org/specifications/core-metadata/#description>`_' ],
                                            'oneOf':         [ {
                                                                       'type':          'string',
                                                                       '$$description': [
                                                                               'Relative path to a text file (UTF-8) '
                                                                               'containing the full description',
                                                                               'of the project. If the file path ends '
                                                                               'in case-insensitive ``.md`` or',
                                                                               '``.rst`` suffixes, '
                                                                               'then the content-type is respectively',
                                            ...
                                            'oneOf':       [ {
                                                                     ...
                                                                     'properties': {
                                                                             'text': {
                                                                                     ...
                                                                                     '$$description': [
                                                                                             'The license of the '
                                                                                             'project whose meaning is that of the',
                                                                                        ...
                                                                                        'properties':           {
                                                                                                ...
                                                                                                'namespaces': {
                                                                                                        ...
                                                                                                        '$$description': [
                                                                                                                ...
                                                                                                                '``True``, directories without a ``__init__.py`` file will also',
                                                                                                                'be '
                                                                                                                'scanned for :pep:`420`-style implicit namespaces' ] } } } } } } } } } },
                        'project':              {
                                '$schema':              'http://json-schema.org/draft-07/schema',
                                '$id':
                                    'https://packaging.python.org/en/latest/specifications/declaring-project-metadata/',
                                ...
                                'properties':           {
                                        ...
                                        'readme':                {
                                                '$$description': [
                                                        '`Full/detailed description of the project in the form of a '
                                                        'README',
                                                        '<https://www.python.org/dev/peps/pep-0621/#readme>`_',
                                                        "with meaning similar to the one defined in `core metadata's "
                                                        "Description",
                                                ...
                                                'oneOf':         [ {
                                                                           ...
                                                                           '$$description': [
                                                                                   ...
                                                                                   'UTF-8) containing the full '
                                                                                   'description',
                                                                                   'of the project. If the file path '
                                                                                   'ends in case-insensitive ``.md`` '
                                                                                   'or',
                                                                                   '``.rst`` suffixes, '
                                                                                   'then the content-type is '
                                                                                   'respectively',
                                        ...
                                        'authors':               {
                                                ...
                                                '$$description': [
                                                        ...
                                                        "of the project.",
                                                        'The exact meaning is open to interpretation (e.g. original '
                                                        'or primary authors,',
                                                        'current maintainers, or owners of the package).' ] },
                                        'maintainers':           {
                                                'type':          'array',
                                        ...
                                        'urls':                  {
                                                'type':                 'object',
                                                'description':          'URLs associated with the project in the form '
                                                                        '``label => value``.',
                                                'additionalProperties': False,
                                                'patternProperties':    {
                                                        '^.+$': {
                                        ...
                                        'scripts':               {
                                                '$ref':          '#/definitions/entry-point-group',
                                                '$$description': [
                                                        'Instruct the installer to create command-line wrappers for '
                                                        'the given',
                                                        '`entry points '
                                                        '<https://packaging.python.org/specifications/entry-points/>`_.' ] },
                                        'gui-scripts':           {
                                                ...
                                                '$$description': [
                                                        ...
                                                        '`entry points '
                                                        '<https://packaging.python.org/specifications/entry-points/>`_.',
                                                        'The difference between ``scripts`` and ``gui-scripts`` is '
                                                        'only relevant in',
                                                        'Windows.' ] },
                                        'entry-points':          {
                                                '$$description':        [
                                                        'Instruct the installer to expose the given modules/functions '
                                                        'via',
                                                        '``entry-point`` discovery mechanism (useful for plugins).',
                                                        'More information available in the `Python packaging guide',
                                                        '<https://packaging.python.org/specifications/entry-points/>`_.' ],
                                ...
                                'if':                   {
                                        ...
                                        '$$comment': [ 'According to :pep:`621`:',
                                                       '    If the core metadata specification lists a field as '
                                                       '"Required", then',
                                                       '    the metadata MUST specify the field statically or list it '
                                                       'in dynamic',
                                                       'In turn, `core metadata`_ defines:',
                                                       '    The required fields are: Metadata-Version, Name, Version.',
                                                       '    All the other fields are optional.',
    ...
    if data_is_dict:
                    ...
                    for data__packagedata_key in data__packagedata:
                        try:
                                    ...
                                    if isinstance(data__packagedata_key, str):
                                        if not custom_formats["python-module-name"](data__packagedata_key):
                                            raise JsonSchemaValueException("" + (name_prefix or "data") +
                                                                           ".package-data must be "
                                                                           "python-module-name",
                                                                           value=data__packagedata_key, name="" + (
                                                        name_prefix or "data") + ".package-data", definition={
                                                        'format': 'python-module-name'}, rule='format')
                                    data__packagedata_key_one_of_count3 += 1
                                except JsonSchemaValueException: pass
                            if data__packagedata_key_one_of_count3 < 2:
                                try:
                                    if data__packagedata_key != "*":
                                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".package-data "
                                                                                                      "must be same "
                                                                                                      "as const "
                                                                                                      "definition: "
                                                                                                      "*",
                            ...
                            if data__packagedata_key_one_of_count3 != 1:
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".package-data must be "
                                                                                              "valid exactly by one "
                                                                                              "definition" + (" (" +
                                                                                                              str(data__packagedata_key_one_of_count3) + " matches found)"), value=data__packagedata_key, name="" + (name_prefix or "data") + ".package-data", definition={'oneOf': [{'format': 'python-module-name'}, {'const': '*'}]}, rule='oneOf')
                        except JsonSchemaValueException:
                            data__packagedata_property_names = False
                    if not data__packagedata_property_names:
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".package-data must be named by"
                                                                                      " propertyName definition",
                                                       value=data__packagedata, name="" + (name_prefix or "data") +
                                    ...
                                    '$$description': ['Mapping from package names to lists of glob patterns.',
                                                      ...
                                                      '``include-package-data = true``', 'For more information on how '
                                                                                         'to include data files, '
                                                                                         'check ``setuptools`` '
                                                                                         '`docs',
                                                      '<https://setuptools.pypa.io/en/latest/userguide/datafiles.html>`_.'], 'type': 'object', 'additionalProperties': False, 'propertyNames': {'oneOf': [{'format': 'python-module-name'}, {'const': '*'}]}, 'patternProperties': {'^.*$': {'type': 'array', 'items': {'type': 'string'}}}}, rule='propertyNames')
        if "include-package-data" in data_keys:
            ...
            if not isinstance(data__includepackagedata, (bool)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".include-package-data must be "
                                                                              "boolean",
                                               value=data__includepackagedata, name="" + (name_prefix or "data") +
                                                                                    ".include-package-data",
                                               definition={'$$description': ['Automatically include any data files '
                                                                             'inside the package directories',
                                                                             'that are specified by ``MANIFEST.in``',
                                                                             'For more information on how to include '
                                                                             'data files, check ``setuptools`` '
                                                                             '`docs',
                                                                             '<https://setuptools.pypa.io/en/latest/userguide/datafiles.html>`_.'], 'type': 'boolean'}, rule='type')
            ...
            if not isinstance(data__excludepackagedata, (dict)):
                raise JsonSchemaValueException("" + (name_prefix or "data") + ".exclude-package-data must be object",
                                               value=data__excludepackagedata, name="" + (name_prefix or "data") +
                                                                                    ".exclude-package-data",
                                               definition={'$$description': ['Mapping from package names to lists of '
                                                                             'glob patterns that should be excluded',
                                                                             'For more information on how to include '
                                                                             'data files, check ``setuptools`` '
                                                                             '`docs',
                                                                             '<https://setuptools.pypa.io/en/latest/userguide/datafiles.html>`_.'], 'type': 'object', 'additionalProperties': False, 'propertyNames': {'oneOf': [{'format': 'python-module-name'}, {'const': '*'}]}, 'patternProperties': {'^.*$': {'type': 'array', 'items': {'type': 'string'}}}}, rule='type')
            ...
            if data__excludepackagedata_is_dict:
                ...
                for data__excludepackagedata_key, data__excludepackagedata_val in data__excludepackagedata.items():
                    if REGEX_PATTERNS['^.*$'].search(data__excludepackagedata_key):
                        ...
                        if not isinstance(data__excludepackagedata_val, (list, tuple)):
                            raise JsonSchemaValueException("" + (name_prefix or "data") + ".exclude-package-data.{"
                                                                                          "data__excludepackagedata_key}".format(**locals()) + " must be array", value=data__excludepackagedata_val, name="" + (name_prefix or "data") + ".exclude-package-data.{data__excludepackagedata_key}".format(**locals()) + "", definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
                            ...
                            for data__excludepackagedata_val_x, data__excludepackagedata_val_item in enumerate(
                                ...
                                if not isinstance(data__excludepackagedata_val_item, (str)):
                                    raise JsonSchemaValueException("" + (name_prefix or "data") +
                                                                   ...
                                                                   "data__excludepackagedata_val_x}]".format(
                ...
                if data__excludepackagedata_keys:
                    raise JsonSchemaValueException("" + (name_prefix or "data") + ".exclude-package-data must not "
                                                                                  "contain "+str(
                        data__excludepackagedata_keys)+" properties", value=data__excludepackagedata, name="" + (
                            name_prefix or "data") + ".exclude-package-data", definition={'$$description': ['Mapping '
                                                                                                            'from '
                                                                                                            'package '
                                                                                                            'names to '
                                                                                                            'lists of '
                                                                                                            ...
                                                                                                            'should '
                                                                                                            'be '
                                                                                                            'excluded', 'For more information on how to include data files, check ``setuptools`` `docs', '<https://setuptools.pypa.io/en/latest/userguide/datafiles.html>`_.'], 'type': 'object', 'additionalProperties': False, 'propertyNames': {'oneOf': [{'format': 'python-module-name'}, {'const': '*'}]}, 'patternProperties': {'^.*$': {'type': 'array', 'items': {'type': 'string'}}}}, rule='additionalProperties')
                    ...
                    for data__excludepackagedata_key in data__excludepackagedata:
                        try:
                                ...
                                try:
                                    if isinstance(data__excludepackagedata_key, str):
                                        if not custom_formats["python-module-name"](data__excludepackagedata_key):
                                            raise JsonSchemaValueException("" + (name_prefix or "data") +
                                                                           ".exclude-package-data must be "
                                                                           "python-module-name",
                                                                           value=data__excludepackagedata_key,
                                                                           name="" + (name_prefix or "data") +
                                                                                ".exclude-package-data", definition={
                                                        'format': 'python-module-name'}, rule='format')
                            ...
                            if data__excludepackagedata_key_one_of_count4 < 2:
                                try:
                                    if data__excludepackagedata_key != "*":
                                        raise JsonSchemaValueException("" + (name_prefix or "data") +
                                                                       ".exclude-package-data must be same as const "
                                                                       "definition: *",
                                                                       value=data__excludepackagedata_key,
                                                                       name="" + (name_prefix or "data") +
                                                                            ".exclude-package-data", definition={
                            ...
                            if data__excludepackagedata_key_one_of_count4 != 1:
                                raise JsonSchemaValueException("" + (name_prefix or "data") + ".exclude-package-data "
                                                                                              "must be valid exactly "
                                                                                              "by one definition" + (
                                        " (" + str(data__excludepackagedata_key_one_of_count4) + " matches found)"),
                                                               value=data__excludepackagedata_key, name="" + (
                                            name_prefix or "data") + ".exclude-package-data", definition={'oneOf': [{
                                            'format': 'python-module-name'}, {'const': '*'}]}, rule='oneOf')
                        except JsonSchemaValueException:
                            data__excludepackagedata_property_names = False
                    if not data__excludepackagedata_property_names:
                        raise JsonSchemaValueException("" + (name_prefix or "data") + ".exclude-package-data must be "
                                                                                      "named by propertyName "
                                                                                      "definition",
                                                       value=data__excludepackagedata, name="" + (name_prefix or
                                                                                                  "data") +
                                                                                            ".exclude-package-data",
                                                       definition={'$$description': ['Mapping from package names to '
                                                                                     'lists of glob patterns that '
                                                                                     'should be excluded',
                                                                                     'For more information on how to '
                                                                                     'include data files, '
                                                                                     'check ``setuptools`` `docs',
                                                                                     '<https://setuptools.pypa.io/en/latest/userguide/datafiles.html>`_.'], 'type': 'object', 'additionalProperties': False, 'propertyNames': {'oneOf': [{'format': 'python-module-name'}, {'const': '*'}]}, 'patternProperties': {'^.*$': {'type': 'array', 'items': {'type': 'string'}}}}, rule='propertyNames')
...
def validate_https___packaging_python_org_en_latest_specifications_declaring_project_metadata(data, custom_formats={}, name_prefix=None):
    if not isinstance(data, (dict)):
        raise JsonSchemaValueException( "" + (name_prefix or "data") + " must be object", value = data,
                    ...
                    '$id':                  'https://packaging.python.org/en/latest/specifications/declaring-project-metadata/',
                    'title':                'Package metadata stored in the ``project`` table',
                    '$$description':        [ 'Query structure for the **project** table inside ``pyproject.toml``',
                                              '(as initially defined in :pep:`621`)' ],
                    'type':                 'object',
                    'properties':           {
                            'name':                  {
                            ...
                            'dynamic':               {
                                    ...
                                    '$$description': [
                                            ...
                                            'dynamically provided by build tools' ],
                                    'items':         {
                                            'enum': [ 'version', 'description', 'readme', 'requires-python', 'license',
