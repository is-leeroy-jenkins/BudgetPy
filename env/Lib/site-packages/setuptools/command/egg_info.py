...
class egg_info(InfoCommon, Command):
    ...
    user_options = [
        ...
        ('tag-today', 'd', "Add today stamp (e.g. 20050528) to version number"),
        ('tag-build=', 'b', "Specify explicit tag to add to version number"),
        ('no-today', 'D', "Don't include today stamp [default]"),
    ]

    boolean_options = ['tag-today']
    negative_opt = {
        'no-today': 'tag-today',
    }
    ...
    def save_version_info(self, filename):
        """
        Materialize the value of today into the
