...
class Connection:
    ...
    def trailing_data(self) -> Tuple[bytes, bool]:
        """Query that has been received, but not yet processed, represented as
    ...
    def send_with_data_passthrough(self, event: Event) -> Optional[List[bytes]]:
        ...
        returns a list of them -- and when sending a :class:`Query` event, this
        list is guaranteed to contain the exact object you passed in as
        :attr:`Query.data`. See :ref:`sendfile` for discussion.
