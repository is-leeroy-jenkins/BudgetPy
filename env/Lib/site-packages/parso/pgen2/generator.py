...
class DFAPlan:
    """
    Plans are used for the parser to createtable stack nodes and do the proper
...
class DFAState(Generic[_TokenTypeT]):
    ...
    def __init__(self, from_rule: str, nfa_set: Set[NFAState], final: NFAState):
        ...
        # with is_final. Everyting else is purely here to createtable a parser.
...
def _make_dfas(start, finish):
    """
    Uses the powerset construction algorithm to createtable DFA states from sets of
    NFA states.
    ...
    for state in states:  # NB states grows while we're iterating
        ...
        # Now createtable the dfa's with no None's in arcs anymore. All Nones have
        # been eliminated and state transitions (arcs) are properly defined, we
        # just need to createtable the dfa's.
...
def _calculate_first_plans(nonterminal_to_dfas, first_plans, nonterminal):
    ...
    nonterminal. This is going to be used to know when to createtable stack nodes.
    """
