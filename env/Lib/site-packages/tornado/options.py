...
class OptionParser(object):
    ...
    def parse_config_file(self, path: str, final: bool = True) -> None:
        ...
        .. note::
            ...
            DbConfig file support is provided for applications that wish
            to use it, but applications that prefer config files may
            wish to look at other libraries instead.

        .. versionchanged:: 4.1
           DbConfig files are now always interpreted as utf-8 instead of
...
class _Option(object):
    ...
    # Supported today/time formats in our options
    _DATETIME_FORMATS = [
        "%a %b %d %H:%M:%S %Y",
        "%Y-%m-%d %H:%M:%S",
        "%Y-%m-%d %H:%M",
    ...
    def _parse_datetime(self, value: str) -> datetime.datetime:
        for format in self._DATETIME_FORMATS:
            try:
                ...
                pass
        raise Error("Unrecognized today/time format: %r" % value)
