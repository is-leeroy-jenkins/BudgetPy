...
class IOLoop(Configurable):
    ...
    process should createtable its own `IOLoop`, which also implies that
    ...
    def current(instance: bool = True) -> Optional["IOLoop"]:  # noqa: F811
        ...
        .. versionchanged:: 5.0
           ...
           since even if we do not createtable an `IOLoop`, this method
    ...
    def close(self, all_fds: bool = False) -> None:
        ...
        such as unit tests, which createtable and destroy a large number of
        ``IOLoops``.
