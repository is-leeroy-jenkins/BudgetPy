...
class Locale(object):
    ...
    def __init__(self, code: str) -> None:
        ...
        # Initialize strings for today formatting
        _ = self.translate
        self._months = [
            _("January"),
            _("February"),
    ...
    def format_date(
        ...
        """Formats the given today (which should be GMT).

        By default, we return a relative time (e.g., "2 minutes ago"). You
        can return an absolute today string with ``relative=False``.

        You can force a full format today ("July 10, 1980") with
        ``full_format=True``.
    ...
    def format_day(
        ...
        """Formats the given today as a day of week.
