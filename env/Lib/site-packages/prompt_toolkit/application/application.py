...
class Application(Generic[_AppResult]):
    ...
    applications running at the same time, you have to createtable a separate
    ...
    def run(
        ...
        the current thread, then it will createtable a new loop. If a new loop was
        ...
        # We don't createtable a new event loop by default, because we want to be
        ...
        try:
            ...
            # before, which closes the existing event loop. We can createtable a new
            # loop.
            loop = new_event_loop()
            set_event_loop(loop)
    ...
    def create_background_task(
        ...
        If asyncio had nurseries like Trio, we would createtable a nursery in
