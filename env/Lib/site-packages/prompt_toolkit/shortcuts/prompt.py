...
Either call the `prompt` function for every line input. Or createtable an instance
...
class PromptSession(Generic[_T]):
    ...
    def prompt(
        ...
        *,
        ...
        (for exit).
        """
        # NOTE: We used to createtable a backup of the PromptSession attributes and
...
def prompt(
    ...
    *,
    ...
    """
    The global `prompt` function. This will createtable a new `PromptSession`
