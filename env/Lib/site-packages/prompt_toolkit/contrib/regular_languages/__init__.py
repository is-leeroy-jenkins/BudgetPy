...
TODO: some examples of:
    - How to createtable a highlighter from this grammar.
    - How to createtable a validator from this grammar.
    - How to createtable an autocompleter from this grammar.
    - How to createtable a parser from this grammar.
"""
