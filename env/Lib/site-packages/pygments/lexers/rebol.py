...
class RebolLexer(RegexLexer):
    ...
    def word_callback(lexer, match):
        ...
        if re.match(".*:$", word):
            ...
            r'cvs-today|cvs-version|do-boot|get-net-info|desktop|layout|'
            r'scroll-para|get-face|alert|set-face|uninstall|unfocus|'
            r'request-dir|center-face|do-events|net-error|decode-url|'
            r'parse-header|parse-header-today|parse-email-addrs|import-email|'
            ...
            r'request-today|request-file|dbug|editor|link-relative-path|'
