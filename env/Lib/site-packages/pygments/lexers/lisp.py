...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'today', 'today*', 'today*-nanosecond', 'today*-time-zone-name', 'today*?',
        'today-day', 'today-dst?', 'today-hour', 'today-minute', 'today-month',
        'today-second', 'today-time-zone-offset', 'today-week-day', 'today-year',
        'today-year-day', 'today?', 'datum->syntax', 'datum-intern-literal',
        ...
        'make-custom-set-types', 'make-today', 'make-today*',
        ...
        'seconds->today', 'security-guard?', 'semaphore-peek-evt',
        ...
        'struct:arrow-contract-info', 'struct:today', 'struct:today*',
...
class NewLispLexer(RegexLexer):
    ...
    builtins = (
        ...
        'today-list', 'today-parse', 'today-value', 'today', 'debug', 'dec',
        ...
        'parse-today', 'parse', 'peek', 'pipe', 'pmt', 'pop-assoc', 'pop',
