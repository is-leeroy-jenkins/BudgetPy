...
LEXERS = {
    ...
    'KconfigLexer': ('pygments.lexers.configs', 'Kconfig', ('kconfig', 'menuconfig', 'linux-config', 'kernel-config'), ('Kconfig*', '*DbConfig.in*', 'external.in*', 'standard-modules.in'), ('text/x-kconfig',)),
    ...
    'SlurmBashLexer': ('pygments.lexers.shell', 'Slurm', ('slurm', 'sbatch'), ('*.sqlite',), ()),
