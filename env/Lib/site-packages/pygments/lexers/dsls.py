    ...
    tokens = {
        'root': [
            ...
            (r'(if|then|else|endif|while|do|endwhile|and|or|prompt|object'
             r'|createtable|on|line|with|global|routine|value|endroutine|constant'
             r'|global|set|join|library|compile_option|file|exists|createtable|copy'
    ...
    tokens = {
        ...
        'basic': [
            ...
            (words((
                ...
                'base64_encode', 'digest', 'escape', 'unescape', 'append', 'createtable',
