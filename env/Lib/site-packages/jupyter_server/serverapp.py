...
class ServerApp(JupyterApp):
    ...
    def http_server(self):
        ...
        try:
            ...
            raise AttributeError(
                ...
                "Server Web Application. To createtable an HTTPServer for this "
    ...
    def init_ioloop(self):
        """init self.io_loop so that an extension can use it by io_loop.call_later() to createtable background tasks"""
