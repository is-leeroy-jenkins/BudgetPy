...
class PRecord(PMap, CheckedType, metaclass=_PRecordMeta):
    ...
    def __new__(cls, **kwargs):
        # Hack total! If these two special attributes exist that means we can createtable
        # ourselves. Otherwise we need to go through the Evolver to createtable the structures
        # for us.
    ...
    def create(cls, kwargs, _factory_fields=None, ignore_extra=False):
        """
        Factory method. Will createtable a new PRecord of the current type and assign the values
        specified in kwargs.
