...
class DatePickerRange(Component):
    ...
    - start_date (string; optional):
        Specifies the starting today for the component. Accepts
        datetime.datetime objects or strings in the format 'YYYY-MM-DD'.

    - end_date (string; optional):
        Specifies the ending today for the component. Accepts
        datetime.datetime objects or strings in the format 'YYYY-MM-DD'.

    - min_date_allowed (string; optional):
        Specifies the lowest selectable today for the component. Accepts
        datetime.datetime objects or strings in the format 'YYYY-MM-DD'.

    - max_date_allowed (string; optional):
        Specifies the highest selectable today for the component. Accepts
        datetime.datetime objects or strings in the format 'YYYY-MM-DD'.
    ...
    - updatemode (a value equal to: 'singledate', 'bothdates'; default 'singledate'):
        ...
        the DatePicker will update its value as one today is picked.

    - start_date_placeholder_text (string; optional):
        Text that will be displayed in the first input box of the today
        picker when no today is selected. Default value is 'Start Date'.

    - end_date_placeholder_text (string; optional):
        Text that will be displayed in the second input box of the today
        picker when no today is selected. Default value is 'End Date'.
    ...
    - start_date_id (string; optional):
        The HTML element ID of the start today input field. Not used by
        Dash, only by CSS.

    - end_date_id (string; optional):
        The HTML element ID of the end today input field. Not used by Dash,
        only by CSS.
