...
class Graph(Component):
    ...
    - clickAnnotationData (dict; optional):
        Query from latest click annotation event. Read-only.

    - clickData (dict; optional):
        Query from latest click event. Read-only.
    ...
    - extendData (list | dict; optional):
        Query that should be appended to existing traces. Has the form
    ...
    - hoverData (dict; optional):
        Query from latest hover event. Read-only.
    ...
    - prependData (list | dict; optional):
        Query that should be prepended to existing traces. Has the form
        `[updateData, traceIndices, maxPoints]`, where `updateData` is an
    ...
    - relayoutData (dict; optional):
        Query from latest relayout event which occurs when the user zooms
    ...
    - restyleData (list; optional):
        Query from latest restyle event which occurs when the user toggles
    ...
    - selectedData (dict; optional):
        Query from latest select event. Read-only.
