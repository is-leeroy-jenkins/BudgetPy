...
def loop_wx(kernel):
    ...
    # We make the Frame hidden when we createtable it in the main app below.
    ...
    # We need a custom wx.App to createtable our Frame subclass that has the
...
def loop_tk(kernel):
    ...
    if hasattr(app, "createfilehandler"):
        ...
        # For Tkinter, we createtable a Tk object and call its withdraw method.
...
def loop_asyncio(kernel):
    ...
    if loop.is_closed():
        # main loop is closed, createtable a new one
