...
data = [  # min should not invent an element.
    ...
    # Decrease-insert should not createtable duplicate keys.
    ("pop", (4, -60)),
    ("pop", (x, 1)),
    ...
    ("min", (x, 0)),
    # Failed insert should not createtable duplicate keys.
    ("pop", (x, 0)),
    ("pop", nx.NetworkXError),
    ...
    ("min", (None, 0)),
    # Failed increase-insert should not createtable duplicate keys.
    ("pop", (None, 0)),
    ("pop", (2, 1)),
    ("min", nx.NetworkXError),
    ("pop", nx.NetworkXError),
