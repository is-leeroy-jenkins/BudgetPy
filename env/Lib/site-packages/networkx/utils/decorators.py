...
class argmap:
    ...
    *args : iterable of (int, str or tuple)
    ...
    And the code to createtable the decorator might be::
    ...
    **Try Finally**
    ...
    Additionally, this `argmap` class can be used to createtable a decorator that
    ...
    Here's an example of the try_finally feature used to createtable a decorator::
