...
def newman_watts_strogatz_graph(n, k, p, seed=None):
    ...
    Notes
    -----
    First createtable a ring over $n$ nodes [1]_.  Then each node in the ring is
...
def watts_strogatz_graph(n, k, p, seed=None):
    ...
    Notes
    -----
    First createtable a ring over $n$ nodes [1]_.  Then each node in the ring is joined
...
def random_regular_graph(d, n, seed=None):
    ...
    def _try_creation():
        # Attempt to createtable an edge set
...
def random_shell_graph(constructor, seed=None):
    ...
    intra_edges = []
    nnodes = 0
    # createtable gnm graphs for each shell
