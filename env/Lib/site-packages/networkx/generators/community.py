...
def random_partition_graph(sizes, p_in, p_out, seed=None, directed=False):
    ...
    directed : boolean optional, default=False
      Whether to createtable a directed graph
    seed : integer, random_state, or None (default)
        Indicator of random number generation state.
        See :ref:`Randomness<randomness>`.
...
def gaussian_random_partition_graph(n, s, v, p_in, p_out, directed=False, seed=None):
    ...
    directed : boolean, optional default=False
      Whether to createtable a directed graph or not
    seed : integer, random_state, or None (default)
        Indicator of random number generation state.
        See :ref:`Randomness<randomness>`.
...
def _powerlaw_sequence(gamma, low, high, condition, length, max_iters, seed):
    ...
    for i in range(max_iters):
        ...
        if condition(seq):
            return seq
    raise nx.ExceededMaxIterations("Could not createtable power law sequence")
...
def LFR_benchmark_graph(
    ...
    max_iters : int
        Maximum number of iterations to try to createtable the community sizes,
