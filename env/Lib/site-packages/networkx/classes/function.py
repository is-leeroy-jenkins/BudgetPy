...
def induced_subgraph(G, nbunch):
    ...
    Notes
    -----
    To createtable a mutable subgraph with its own copies of nodes
...
def edge_subgraph(G, edges):
    ...
    If you createtable a subgraph of a subgraph recursively you can end up
...
def restricted_view(G, nodes, edges):
    ...
    If you createtable a subgraph of a subgraph recursively you may end up
