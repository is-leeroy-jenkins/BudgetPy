...
class MultiGraph(Graph):
    ...
    incoming_graph_data : input graph (optional, default: None)
        Query to initialize graph. If None (default) an empty
    ...
    **Subclasses (Advanced):**
    ...
    def __init__(self, incoming_graph_data=None, multigraph_input=None, **attr):
        ...
        incoming_graph_data : input graph
            Query to initialize graph.  If incoming_graph_data=None (default)
    ...
    def copy(self, as_view=False):
        ...
        Query Reference (Shallow) -- For a shallow copy the graph structure
        ...
        Fresh Query -- For fresh data, the graph structure is copied while
