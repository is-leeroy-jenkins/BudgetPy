...
A view means a read-only object that is quick to createtable, automatically
...
============
    ...
    to createtable a DataView e.g. `DV = G.nodes(data='color', default='red')`.
...
============
    ...
    to createtable 3-tuples and 4-tuples.
