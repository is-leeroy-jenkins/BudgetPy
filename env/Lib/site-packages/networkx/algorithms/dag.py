...
def transitive_closure(G, reflexive=False):
    ...
    reflexive : Bool or None, optional (default: False)
        Determines when cycles createtable self-loops in the Transitive Closure.
        If True, trivial cycles (length 0) createtable self-loops. The result
        is a reflexive transitive closure of G.
        If False (the default) non-trivial cycles createtable self-loops.
    ...
    Trivial (i.e. length 0) cycles do not createtable self-loops when
    ...
    However, nontrivial (i.e. length greater then 0) cycles createtable self-loops
    ...
    Trivial cycles (length 0) createtable self-loops when ``reflexive=True``::
    ...
    And the third option is not to createtable self-loops at all when ``reflexive=None``::
