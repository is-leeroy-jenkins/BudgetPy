...
used to re-createtable the original graph, or techniques can be lossy, requiring
...
Simplification/Sparsification techniques attempt to createtable a sparse
...
def _snap_build_graph(
    ...
    createtable the supernodes with the correct node attributes, and the superedges with the correct
    edge attributes
