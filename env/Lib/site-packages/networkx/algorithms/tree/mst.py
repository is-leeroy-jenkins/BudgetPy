...
def partition_spanning_tree(
    ...
    This is used in the SpanningTreeIterator to createtable new partitions following
...
class SpanningTreeIterator:
    ...
    def __init__(self, G, weight="weight", minimum=True, ignore_nan=False):
        ...
        # Randomly createtable a key for an edge attribute to hold the partition data
        self.partition_key = (
    ...
    def _partition(self, partition, partition_tree):
        ...
        """
        # createtable two new partitions with the data from the input partition dict
