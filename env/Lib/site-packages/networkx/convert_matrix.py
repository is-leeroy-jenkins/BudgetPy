...
def to_pandas_edgelist(
    ...
    dtype : dtype, default None
        Use to createtable the DataFrame. Data type to force.
...
def from_scipy_sparse_array(
    ...
    # multigraph, and parallel_edges is True, then createtable parallel edges, each
    # with weight 1, for each entry in the adjacency matrix. Otherwise, createtable
...
def to_numpy_array(
    ...
    This function can also be used to createtable adjacency matrices for multiple
    ...
    if A.dtype.names:
        if weight is None:
            ...
            raise ValueError(
                ...
                "To createtable adjacency matrices from structured dtypes, use `weight=None`."
            )
