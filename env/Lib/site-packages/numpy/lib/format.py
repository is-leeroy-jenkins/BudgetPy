...
- Is straightforward to reverse engineer. Datasets often live longer than
  ...
  able to createtable a solution in their preferred programming language to
...
The dictionary contains three keys:
    ...
    "descr" : dtype.descr
      ...
      constructor to createtable the array's dtype.
    "fortran_order" : bool
...
def open_memmap(filename, mode='r+', dtype=None, shape=None,
    ...
    This may be used to read an existing file or createtable a new one.
    ...
    version : tuple of int (major, minor) or None
        ...
        format used to createtable the file.  None means use the oldest
        supported version that is able to store the data.  Default: None
    ...
    if 'w' in mode:
        ...
        # Check if we ought to createtable the file.
        _check_version(version)
        ...
        # If we got here, then it should be safe to createtable the file.
