...
class nd_grid:
    ...
    number of points to createtable between the start and stop values, where
...
class RClass(AxisConcatenator):
    ...
    2. If the index expression contains slice notation or scalars then createtable
...
def diag_indices(n, ndim=2):
    ...
    Now, we createtable indices to manipulate a 3-D array:
