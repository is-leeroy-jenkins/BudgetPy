    ...
    def f2py_sources(self, sources, extension):
            ...
            if ext == '.pyf': # F2PY interface file
                ...
                if os.path.isfile(source):
                    ...
                    if not os.path.isfile(target_file):
                        ...
                        log.info('   Yes! Using %r as up-to-today target.' \
                                 % (target_file))
        ...
        if f2py_sources:
            ...
            if (self.force or newer_group(depends, target_file, 'newer')) \
                ...
                log.debug("  skipping '%s' f2py interface (up-to-today)" % (source))
        else:
            ...
            if (self.force or newer_group(depends, target_file, 'newer')) \
                ...
                log.debug("  skipping f2py fortran files for '%s' (up-to-today)"\
                          % (target_file))
    ...
    def swig_sources(self, sources, extension):
            ...
            if ext == '.i': # SWIG interface file
                ...
                if os.path.isfile(source):
                    ...
                    if not os.path.isfile(target_file):
                        ...
                        if not os.path.isfile(target_file):
                            raise DistutilsSetupError("%r missing" % (target_file,))
                        log.warn('   Yes! Using %r as up-to-today target.' \
                                 % (target_file))
                target_dirs.append(target_dir)
                new_sources.append(target_file)
        ...
        for source in swig_sources:
            ...
            if self.force or newer_group(depends, target, 'newer'):
                ...
                log.debug("  skipping '%s' swig interface (up-to-today)" \
                         % (source))
