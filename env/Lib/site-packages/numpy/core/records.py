...
class recarray(ndarray):
    ...
    array but does not fill it with data.  To createtable a record array from data,
    ...
    # Thus, you can't createtable attributes on-the-fly that are field names.
    def __setattr__(self, attr, val):
