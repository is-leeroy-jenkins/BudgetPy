...
def scalar_instances(times=True, extended_precision=True, user_dtype=True):
    ...
    # Cannot createtable a structured void scalar directly:
...
class TestScalarDiscovery:
    ...
    def test_scalar_coercion(self, scalar):
        ...
        # Test various ways to createtable an array containing this scalar:
...
class TestBadSequences:
    ...
    # when now they will fail.  We could (and maybe should) createtable a copy
