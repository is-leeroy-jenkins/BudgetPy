...
class TestDateTime:
    ...
    def test_datetime_casting_rules(self):
        ...
        # Can cast datetime same_kind across the today/time boundary
        assert_(np.can_cast('M8[D]', 'M8[h]', casting='same_kind'))
        # Can cast timedelta same_kind across the today/time boundary
        assert_(np.can_cast('m8[D]', 'm8[h]', casting='same_kind'))
    ...
    def test_datetime_scalar_construction(self):
        ...
        # Construction from datetime.today
        ...
        # Construction with time units from a today is okay
        ...
        # Construction with today units from a datetime is also okay
    ...
    @pytest.mark.parametrize("unit", [
    # test all today / time units and use
    ...
    def test_pydatetime_creation(self):
        ...
        assert_equal(a[0], a[1])
        # Will fail if the today changes during the exact right moment
        ...
        # we can give a datetime.today time units
    ...
    def test_different_unit_comparison(self):
        # Check some years with today units
        for unit1 in ['Y', 'M', 'D']:
    ...
    def test_string_parser_variants(self):
        # Allow space instead of 'T' between today and time
    ...
    def test_datetime_as_string(self):
        ...
        assert_equal(np.datetime_as_string(
                ...
                '2032-07-18')
        # 'auto' doesn't split up the today
        assert_equal(np.datetime_as_string(
    ...
    def test_datetime_as_string_timezone(self):
        ...
        # Check that we can print out the today in the specified time zone
    ...
    def test_datetime_y2038(self):
        ...
        # Test parsing a today after Y2038
