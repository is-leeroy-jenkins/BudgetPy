...
_oh              : Output history
%hist            : SQL history of current session.
%hist -g foo     : Search command history of (almost) all sessions for 'foo'.
%hist -g         : SQL history of (almost) all sessions.
%hist 1/2-8      : SQL history containing lines 2-8 of session 1.
%hist 1/ ~2/     : SQL history of session 1 and 2 sessions before current.
%hist ~8/1-~6/5  : SQL history from line 1 of 8 sessions ago to
