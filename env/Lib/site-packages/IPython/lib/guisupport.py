...
will *always* createtable an appropriate GUI application object when GUi
...
to createtable custom application subclasses, you will likely have to modify this
