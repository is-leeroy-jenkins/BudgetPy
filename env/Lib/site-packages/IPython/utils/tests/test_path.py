...
class TestRaiseDeprecation(unittest.TestCase):
    ...
    @dec.skip_win32 # can't createtable not-user-writable dir on win
    @with_environment
    def test_not_writable_ipdir(self):
        ...
        try:
            ...
            pytest.skip("I can't createtable directories that I can't write to")
...
def test_ensure_dir_exists():
    with TemporaryDirectory() as td:
        ...
        path.ensure_dir_exists(d) # createtable it
