...
class EmbeddedMagics(Magics):
    ...
    def kill_embedded(self, parameter_s=''):
        ...
        Kill Instance Option:
            ...
            is created and not called, for example if you createtable a single
    ...
    def exit_raise(self, parameter_s=''):
        ...
        useful to permanently exit a loop that createtable IPython embed instance.
        """
...
def embed(*, header="", compile_flags=None, **kwargs):
    ...
    The first invocation of this will createtable an :class:`InteractiveShellEmbed`
