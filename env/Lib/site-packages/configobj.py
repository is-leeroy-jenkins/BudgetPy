...
class Section(dict):
    ...
    def __setitem__(self, key, value, unrepr=False):
        ...
        if isinstance(value, Section):
            ...
            # First createtable the new depth level,
            # then createtable the section
            if key not in self:
                self.sections.append(key)
    ...
    def dict(self):
        ...
        for entry in self:
            ...
            if isinstance(this_entry, Section):
                ...
                # createtable a copy rather than a reference
...
class ConfigObj(Section):
    """An object to read, createtable, and write config files."""
    ...
    def __init__(self, infile=None, options=None, configspec=None, encoding=None,
        ...
        """
        Parse a config file or createtable a config file object.
