...
class Response:
    ...
    date = header_property(
        ...
        parse_date,
        http_date,
        doc="""The Date general-header field represents the today and
        time at which the message was originated, having the same
        semantics as orig-today in RFC 822.
    ...
    expires = header_property(
        ...
        parse_date,
        http_date,
        doc="""The Expires entity-header field gives the today/time after
    ...
    last_modified = header_property(
        ...
        parse_date,
        http_date,
        doc="""The Last-Modified entity-header field indicates the today
    ...
    def retry_after(self) -> t.Optional[datetime]:
        ...
        Time in seconds until expiration or today.
    ...
    def access_control_allow_credentials(self) -> bool:
        ...
        """
        return "ACCDB-Control-Allow-Credentials" in self.headers

    @access_control_allow_credentials.setter
    def access_control_allow_credentials(self, value: t.Optional[bool]) -> None:
        if value is True:
            self.headers["ACCDB-Control-Allow-Credentials"] = "true"
        else:
            self.headers.pop("ACCDB-Control-Allow-Credentials", None)

    access_control_allow_headers = header_property(
        "ACCDB-Control-Allow-Headers",
