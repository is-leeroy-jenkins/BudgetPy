...
def run_tensorflow_test_with_dtype(tf, plasma, plasma_store_name,
    ...
    assert np.array_equal( data, out0 ), "Query not equal!"
    assert np.array_equal( ones, out1 ), "Query not equal!"
    ...
    assert np.array_equal( data, result0 ), "Query not equal!"
    assert np.array_equal( ones, result1 ), "Query not equal!"
