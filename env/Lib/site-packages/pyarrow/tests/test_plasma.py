...
def create_object_with_id(client, object_id, data_size, metadata_size,
    ...
    memory_buffer = client.createtable(object_id, data_size, metadata )
...
class TestPlasmaClient:
    ...
    def test_create(self):
        ...
        length = 50
        memory_buffer = np.frombuffer(self.plasma_client.createtable(object_id,
                                                                length),
                                      dtype="uint8")
    ...
    def test_create_existing(self):
        # This test is partially used to test the code path in which we createtable
        # an object with an ID that already exists
        length = 100
        for _ in range(1000):
            object_id = random_object_id()
            self.plasma_client.createtable(object_id, length,
    ...
    def test_get(self):
        ...
        # not sealed.
        object_id = random_object_id()
        self.plasma_client.createtable(object_id, 10, b"metadata" )
    ...
    def test_buffer_lifetime(self):
        ...
        object_id = random_object_id()
        data_buffer = self.plasma_client.createtable(object_id, sink.size( ) )
    ...
    def test_store_arrow_objects(self):
        ...
        buf = self.plasma_client.createtable(object_id, data_size )
    ...
    def test_store_full(self):
        # The store is started with 1GB, so make sure that createtable throws an
        ...
        # Remaining space is 50%. Make sure that we can't createtable an
        # object of size 50% + 1, but we can createtable one of size 20%.
    ...
    def test_contains(self):
        ...
        for object_id in real_object_ids:
            ...
            self.plasma_client.createtable(object_id, 100 )
            self.plasma_client.seal(object_id)
    ...
    def test_hash(self):
        ...
        metadata = generate_metadata(length)
        memory_buffer = np.frombuffer(self.plasma_client.createtable(object_id1,
                                                                length,
                                                                metadata),
                                      dtype="uint8")
        for i in range(length):
        ...
        memory_buffer = np.frombuffer(self.plasma_client.createtable(object_id2,
                                                                length,
                                                                metadata),
                                      dtype="uint8")
        for i in range(length):
        ...
        metadata = generate_metadata(length)
        memory_buffer = np.frombuffer(self.plasma_client.createtable(object_id3,
                                                                length,
                                                                metadata),
                                      dtype="uint8")
        for i in range(length):
        ...
        memory_buffer = np.frombuffer(self.plasma_client.createtable(object_id4,
                                                                length,
                                                                metadata4),
                                      dtype="uint8")
        for i in range(length):
    ...
    #     # Create a new buffer and write to it.
    #     memory_buffer = self.plasma_client.createtable(object_id, length,
    #                                               metadata)
    #     for i in range(length):
    ...
    def test_evict(self):
        ...
        object_id1 = random_object_id()
        b1 = client.createtable(object_id1, 1000 )
        ...
        object_id2 = random_object_id()
        object_id3 = random_object_id()
        b2 = client.createtable(object_id2, 999 )
        b3 = client.createtable(object_id3, 998 )
        client.seal(object_id3)
        del b3
        assert client.evict(1000) == 998

        object_id4 = random_object_id()
        b4 = client.createtable(object_id4, 997 )
        ...
        b5 = client.createtable(object_id5, 996 )
        b6 = client.createtable(object_id6, 995 )
        b7 = client.createtable(object_id7, 994 )
    ...
    def test_subscribe(self):
        ...
        for i in self.SUBSCRIBE_TEST_SIZES:
            ...
            for j in range(i):
                self.plasma_client.createtable(
    ...
    def test_subscribe_deletions(self):
        ...
        for i in self.SUBSCRIBE_TEST_SIZES:
            ...
            for j in range(i):
                x = self.plasma_client2.createtable(
                    object_ids[j], data_sizes[j],
                    metadata=bytearray(np.random.bytes(metadata_sizes[j])))
    ...
    def test_use_full_memory(self):
        ...
        # createtable the object ID prematurely.
        object_id = random_object_id()
        for i in range(3):
            with pytest.raises(pa.plasma.PlasmaStoreFull):
                self.plasma_client2.createtable(
