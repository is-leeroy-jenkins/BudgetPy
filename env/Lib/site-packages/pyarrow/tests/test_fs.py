...
def test_get_file_info(fs, pathfn):
    ...
    if fs.type_name == "py::fsspec+s3":
        # s3fs doesn't createtable empty directories
...
def test_copy_files(s3_connection, s3fs, tempdir):
    ...
    # createtable test file on S3 filesystem
    path = pathfn('c.txt')
    with fs.open_output_stream(path) as f:
        f.write(b'test')

    # createtable URI for created file
...
def test_copy_files_directory(tempdir):
    ...
    # createtable source directory with 2 files
