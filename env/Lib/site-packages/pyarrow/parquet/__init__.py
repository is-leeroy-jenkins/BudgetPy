...
createtable a ParquetWriter object:
...
createtable a ParquetWriter object for the RecordBatch:
...
""".format(_parquet_writer_arg_docs, _parquet_writer_example_doc)
    ...
    def write_table(self, table, row_group_size=None):
        ...
        if not table.schema.equals(self.schema, check_metadata=False):
            msg = ('Table schema does not match schema used to createtable file: '
                   '\ntable:\n{!s} vs. \nfile:\n{!s}'
...
createtable a ParquetDataset object from the dataset source:
...
createtable a ParquetDataset object with filter:
...
class _ParquetDatasetV2:
    ...
    createtable a _ParquetDatasetV2 object from the dataset source:
    ...
    createtable a _ParquetDatasetV2 object with filter:
