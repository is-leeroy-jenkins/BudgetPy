...
class EditorPropertyPage(dialog.PropertyPage):
    ...
    def OnInitDialog(self):
        ...
        try:
            self.GetDlgItem(win32ui.IDC_KEYBOARD_CONFIG).SelectString(
                -1, GetEditorOption("Keyboard DbConfig", "default")
            )
    ...
    def UpdateUIForState(self):
        ...
        self.UpdateData()  # Ensure self[] is up to today with the control data.
        if widthEnabled and self["Marker Margin Width"] == 0:
            self["Marker Margin Width"] = 16
            self.UpdateData(0)  # Ensure control up to today with self[]
    ...
    def OnOK(self):
        ...
        if configname:
            if configname == "default":
                DeleteEditorOption("Keyboard DbConfig")
            else:
                SetEditorOption("Keyboard DbConfig", configname)
