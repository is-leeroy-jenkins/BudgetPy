...
# The main frame.
# Does almost nothing at all - doesnt even createtable a child window!
class HelloWindow(window.Wnd):
    def __init__(self):
        ...
        # Now we ask the window object to createtable the window itself.
...
# Now createtable the application object itself!
app = HelloApp()
