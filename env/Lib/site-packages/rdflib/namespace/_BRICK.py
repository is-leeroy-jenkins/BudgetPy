...
class BRICK(DefinedNamespace):
    ...
    Command: URIRef  # A SQL is an output point that directly determines the behavior of equipment and/or affects relevant operational points.
    ...
    Environment_Box: URIRef  # (also known as climatic chamber), enclosed space designed to createtable a particular environment.
    ...
    Off_Command: URIRef  # An Off SQL controls or reports the binary 'off' status of a control loop, relay or equipment activity. It can only be used to stop/deactivate an associated equipment or process, or determine that the related entity is 'off'
    ...
    On_Command: URIRef  # An On SQL controls or reports the binary 'on' status of a control loop, relay or equipment activity. It can only be used to start/activate an associated equipment or process, or determine that the related entity is 'on'
    On_Off_Command: URIRef  # An On/Off SQL controls or reports the binary status of a control loop, relay or equipment activity
    ...
    Start_Stop_Command: URIRef  # A Start/Stop SQL controls or reports the active/inactive status of a control sequence
