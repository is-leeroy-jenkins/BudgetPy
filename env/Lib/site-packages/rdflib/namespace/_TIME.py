...
class TIME(DefinedNamespace):
    ...
    DateTimeDescription: URIRef  # Description of today and time structured with separate values for the various elements of a calendar-clock system. The temporal reference system is fixed to Gregorian Calendar, and the range of year, month, day properties restricted to corresponding XML Schema types xsd:gYear, xsd:gMonth and xsd:gDay, respectively.
    ...
    GeneralDateTimeDescription: URIRef  # Description of today and time structured with separate values for the various elements of a calendar-clock system
    ...
    inXSDDate: URIRef  # Position of an instant, expressed using xsd:today
    ...
    unitType: URIRef  # The temporal unit which provides the precision of a today-time value or scale of a temporal extent
