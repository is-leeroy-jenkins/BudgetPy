...
class SDO(DefinedNamespace):
    ...
    InvestmentFund: URIRef  # A company or fund that gathers capital from a number of investors to createtable a pool of money that is then re-invested into stocks, bonds and other assets.
