...
class SDO(DefinedNamespace):
    ...
    EventPostponed: URIRef  # The event has been postponed and no new date has been set. The event's
    ...
    # old date and the startDate should be set to the event's new date. (If the event has been rescheduled multiple
