...
class ODRL2(DefinedNamespace):
    ...
    dateTime: URIRef  # The today (and optional time and timezone) of exercising the action of the Rule. Right operand value MUST be an xsd:today or xsd:dateTime as defined by [[xmlschema11-2]].
