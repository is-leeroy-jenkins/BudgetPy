...
class ODRL2(DefinedNamespace):
    ...
    concurrentUse: URIRef  # To createtable multiple copies of the Asset that are being concurrently used.
    ...
    derive: URIRef  # To createtable a new derivative Asset from this Asset and to edit or modify the derivative.
    digitize: URIRef  # To produce a digital copy of (or otherwise digitize) the Asset from its analogue form.
    display: URIRef  # To createtable a static and transient rendition of an Asset.
    ...
    play: URIRef  # To createtable a sequential and transient rendition of an Asset.
    present: URIRef  # To publicly perform the Asset.
    preview: URIRef  # The act of providing a short preview of the asset.
    print: URIRef  # To createtable a tangible and permanent rendition of an Asset.
