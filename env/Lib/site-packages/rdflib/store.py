...
class StoreCreatedEvent(Event):
    ...
    attribute:
      ...
      - ``configuration``: string used to createtable the store
...
class Store(object):
    ...
    def open(self, configuration, create: bool = False):
        ...
        createtable is True a store will be created if it does not already
        exist. If createtable is False and a store does not already exist
