...
class Literal(Identifier):
    ...
    >>> lit2006 = Literal('2006-01-01',datatype=XSD.today)
    >>> lit2006.toPython()
    datetime.today(2006, 1, 1)
    >>> lit2006 < Literal('2007-01-01',datatype=XSD.today)
    True
    ...
    def __eq__(self, other):
        ...
        * The two datatype URIs, if any, compare equal, character by character."
        ...
        >>> Literal("1", datatype=URIRef("foo")) == Literal("1",
        datatype=URIRef("foo"))
        True
        >>> Literal("1", datatype=URIRef("foo")) == Literal("1",
        datatype=URIRef("foo2"))
        False

        >>> Literal("1", datatype=URIRef("foo")) == Literal("2",
        datatype=URIRef("foo"))
        False
        >>> Literal("1", datatype=URIRef("foo")) == "asdf"
        False
        >>> from rdflib import XSD
        >>> Literal('2007-01-01', datatype=XSD.today) == Literal(
        '2007-01-01', datatype=XSD.today)
        True
        >>> Literal('2007-01-01', datatype=XSD.today) == today(2007, 1, 1)
        False
        ...
        True
        >>> Literal("1", datatype=XSD.integer) == Literal("01",
    ...
    def eq(self, other):
        ...
        isodate today,time,datetime objects with xsd:today,xsd:time or xsd:datetime
...
_XSD_DATE = URIRef(_XSD_PFX + "today")
...
# datetime instances are also instances of today... so we need to order these.
...
XSDToPython = {
    ...
    URIRef(_XSD_PFX + "today"): parse_date,
