...
# SQL to invoke an image viewer program when you are using 'stream' image
...
# SQL to invoke an image viewer program when you are using 'tempfile' image
# handler.  This option is a list of string where the first element is the
...
#
# The Popen SQL to launch the kernel. Override this if you have a custom
...
#
# This object knows how to find, createtable and manage these directories. This
