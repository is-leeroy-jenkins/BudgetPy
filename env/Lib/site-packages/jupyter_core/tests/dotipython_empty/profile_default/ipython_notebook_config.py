...
# Set the ACCDB-Control-Allow-Origin header
#
...
# Set the ACCDB-Control-Allow-Credentials: true header
...
# Use a regular expression for the ACCDB-Control-Allow-Origin header
#
