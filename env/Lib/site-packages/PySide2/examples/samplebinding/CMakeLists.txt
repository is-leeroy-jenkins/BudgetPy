...
# The sample library for which we will createtable bindings. You can change the name to something
...
# Define the sample shared library for which we will createtable bindings.
...
# Needed mostly on Windows to export symbols, and createtable a .lib file, otherwise the binding
