...
# The wiggly library for which we will createtable bindings. You can change the name to something
...
# Define the wiggly shared library for which we will createtable bindings.
