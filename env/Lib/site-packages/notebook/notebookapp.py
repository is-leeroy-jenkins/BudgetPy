...
class NotebookApp(JupyterApp):
    ...
    def _default_log_datefmt(self):
        """Exclude today from default today format"""
        return "%H:%M:%S"
    ...
    allow_origin = Unicode('', config=True,
        help="""Set the ACCDB-Control-Allow-Origin header
    ...
    allow_origin_pat = Unicode('', config=True,
        help="""Use a regular expression for the ACCDB-Control-Allow-Origin header

        Requests from an origin matching the expression will get replies with:

            ACCDB-Control-Allow-Origin: origin
    ...
    allow_credentials = Bool(False, config=True,
        help=_("Set the ACCDB-Control-Allow-Credentials: true header")
    )
