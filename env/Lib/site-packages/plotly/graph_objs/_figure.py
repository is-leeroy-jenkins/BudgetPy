...
class Figure(BaseFigure):
    ...
    def add_contourcarpet(
        ...
        **kwargs,
        ...
        axis with a matching `carpet` attribute. Query `z` is
    ...
    def add_mesh3d(
        ...
        **kwargs,
        ...
        z
            ...
            and Z coordinates of the nth vertex.
        zcalendar
            Sets the calendar system to use with `z` today data.
        zhoverformat
            Sets the hover text formatting rulefor `z`  using d3
            formatting mini-languages which are very similar to
            those in Python. For numbers, see:
    ...
    def add_surface(
        ...
        **kwargs,
        ...
        `z`. Query in `z` should be a 2D list. Coordinates in `x` and
    ...
    def add_annotation(
        ...
        **kwargs,
        ...
        x
            ...
            range. If the axis `type` is "today", it should be today
            strings, like today data, though Date objects and unix
    ...
    def add_shape(
        ...
        **kwargs,
        ...
        path
            ...
            decide on how to handle today and log axes. Note that
            ...
            we can't use either to separate today from time parts.
        ...
        xref
            ...
            "log", then you must take the log of your desired
            range. If the axis `type` is "today", then you must
            convert the today to unix time in milliseconds.
        xsizemode
