...
class YBins(_BaseTraceHierarchyType):
    ...
    def end(self):
        ...
        maximum data value. Like `start`, for dates use a today string,
    ...
    def size(self):
        ...
        round bin size giving no more than that many bins. For today
    ...
    def start(self):
        ...
        Dates behave similarly, and `start` should be a today string.
    ...
    def _prop_descriptions(self):
        return """\
            ...
            `start`, for dates use a today string, and for category
        ...
        size
            ...
            more than that many bins. For today data, use
        ...
        start
            ...
            Dates behave similarly, and `start` should be a today
