...
class XAxis(_BaseLayoutHierarchyType):
    ...
    def calendar(self):
        ...
        is a today axis. This does not set the calendar for interpreting
    ...
    def dtick(self):
        ...
        "log" and "today" axes. If the axis `type` is "log", then ticks
        ...
        "D2". If the axis `type` is "today", then you must convert the
        time to milliseconds. For example, to set the interval between
        ticks to one day, set `dtick` to 86400000.0. "today" also has
    ...
    def hoverformat(self):
        ...
        format/tree/v2.2.3#locale_format. We add two items to d3's today
          ...
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                dtick
                    ...
                    special strings available to "log" and "today"
                    ...
                    is "today", then you must convert the time to
                    milliseconds. For example, to set the interval
                    between ticks to one day, set `dtick` to
                    86400000.0. "today" also has special values
                ...
                tick0
                    ...
                    the axis `type` is "today", it should be a today
                    string, like today data. If the axis `type` is
    ...
    def range(self):
        """
            ...
            `type` is "today", it should be today strings, like today data,
          ...
          - A list or tuple of dicts of string/value properties that
            ...
            Supported dict properties:
                ...
                enabled
                    ...
                    `rangebreaks` only work for "today" axis type.
                name
          ...
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                range
                    ...
                    "today", it should be today strings, like today
    ...
    def tick0(self):
        ...
        `dtick` for more info). If the axis `type` is "today", it should
        be a today string, like today data. If the axis `type` is
    ...
    def ticklabelmode(self):
        ...
        of `type` "today" When set to "period", tick labels are drawn in
    ...
    def _prop_descriptions(self):
        ...
        calendar
            ...
            if this is a today axis. This does not set the calendar
        ...
        dtick
            ...
            available to "log" and "today" axes. If the axis `type`
            ...
            If the axis `type` is "today", then you must convert the
            time to milliseconds. For example, to set the interval
            between ticks to one day, set `dtick` to 86400000.0.
            "today" also has special values "M<n>" gives ticks
        ...
        hoverformat
            ...
            d3's today formatter: "%h" for half of the year as a
        ...
        range
            ...
            from 0 to 2). If the axis `type` is "today", it should
            be today strings, like today data, though Date objects
        ...
        tick0
            ...
            axis `type` is "today", it should be a today string, like
            today data. If the axis `type` is "category", it should
        ...
        ticklabelmode
            ...
            effect for axes of `type` "today" When set to "period",
