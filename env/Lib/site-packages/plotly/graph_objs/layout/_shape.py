...
class Shape(_BaseLayoutHierarchyType):
    ...
    def path(self):
        ...
        we would have to decide on how to handle today and log axes.
        ...
        today from time parts. Therefore we'll use underscore for this
    ...
    def xref(self):
        ...
        *x2 domain* refers to the domain of the second x  axis and a x
        ...
        axis `type` is "today", then you must convert the today to unix
