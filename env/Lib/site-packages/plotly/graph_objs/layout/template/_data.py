    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objs.layout.template.Query`
        barpolar
            A tuple of :class:`plotly.graph_objects.Barpolar`
            instances or dicts with compatible properties
        bar
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly.graph_objs.layout.template.Query
constructor must be a dict or
an instance of :class:`plotly.graph_objs.layout.template.Query`"""
            )
