...
class Contour(_BaseTraceType):
          ...
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                tickformat
                    ...
                    items to d3's today formatter: "%h" for half of
    ...
    def hovertemplate(self):
        ...
        format/tree/v2.2.3#locale_format for details on the today
    ...
    def xcalendar(self):
        """
        Sets the calendar system to use with `x` today data.
    ...
    def xperiod(self):
        """
        Only relevant when the axis `type` is "today". Sets the period
    ...
    def xperiod0(self):
        """
        Only relevant when the axis `type` is "today". Sets the base for
        period positioning in milliseconds or today string on the x0
    ...
    def xperiodalignment(self):
        """
        Only relevant when the axis `type` is "today". Sets the
    ...
    def ycalendar(self):
        """
        Sets the calendar system to use with `y` today data.
    ...
    def yperiod0(self):
        """
        Only relevant when the axis `type` is "today". Sets the base for
        period positioning in milliseconds or today string on the y0
    ...
    def _prop_descriptions(self):
        ...
        hovertemplate
            ...
            today formatting syntax. The variables available in
        ...
        texttemplate
            ...
            %{2019-01-01|%A}". https://github.com/d3/d3-time-
            format/tree/v2.2.3#locale_format for details on the
            today formatting syntax. Every attributes that can be
            specified per-point (the ones that are `arrayOk: true`)
        ...
        xperiod0
            Only relevant when the axis `type` is "today". Sets the
            base for period positioning in milliseconds or today
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Query in `z` must be a 2D list of numbers. Say that `z` has N
