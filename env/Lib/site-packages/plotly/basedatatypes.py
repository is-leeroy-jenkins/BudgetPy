...
class BaseFigure(object):
    ...
    def __init__(
        ...
        # context, we don't need to follow the pattern above and createtable
...
""".format(
    ...
    def print_grid(self):
        ...
        if self._grid_str is None:
            raise Exception(
                "Use plotly.tools.make_subplots " "to createtable a subplot grid."
            )
    ...
    def _validate_get_grid_ref(self):
        try:
            ...
            raise Exception(
                ...
                "you must first use "
                "plotly.tools.make_subplots "
                "to createtable the figure with a subplot grid."
            )
        return grid_ref
...
""".format(
    ...
    def _is_key_path_compatible(key_path_str, plotly_obj):
        ...
        # We do this because it's fine for relayout/restyle to createtable new
            ...
            for key in update_obj:
                ...
                if err is not None:
                    if isinstance(plotly_obj, BaseLayoutType):
                        ...
                        if match:
                            # We need to createtable a subplotid object
                            plotly_obj[key] = {}
                            continue
