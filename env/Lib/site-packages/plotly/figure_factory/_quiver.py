...
class _Quiver(object):
    ...
    def get_barbs(self):
        ...
        endpoint pairs to createtable 2 lists: x_values for barbs and y values
        for barbs

        :rtype: (list, list) barb_x, barb_y: list of startpoint and endpoint
            x_value pairs separated by a None to createtable the barb of the arrow,
            and list of startpoint and endpoint y_value pairs separated by a
            None to createtable the barb of the arrow.
        """
    ...
    def get_quiver_arrows(self):
        ...
        separated by a None and zipped to createtable lists of x and y values for
        the arrows.

        :rtype: (list, list) arrow_x, arrow_y: list of point1, endpoint, point2
            x_values separated by a None to createtable the arrowhead and list of
            point1, endpoint, point2 y_values separated by a None to createtable
        ...
        # Set angles to createtable arrow
        ...
        # Set coordinates to createtable arrow
        ...
        # Combine lists to createtable arrow
