    ...
    def __init__(self, plotly_name="scatter", parent_name="", **kwargs):
        super(ScatterValidator, self).__init__(
            ...
            hovertemplate
                ...
                the today formatting syntax. The variables
            ...
            texttemplate
                ...
                https://github.com/d3/d3-time-
                format/tree/v2.2.3#locale_format for details on
                the today formatting syntax. Every attributes
            ...
            xcalendar
                Sets the calendar system to use with `x` today
                data.
            xhoverformat
            ...
            xperiod
                Only relevant when the axis `type` is "today".
            ...
            xperiod0
                ...
                milliseconds or today string on the x0 axis.
            ...
            ycalendar
                Sets the calendar system to use with `y` today
                data.
            yhoverformat
            ...
            yperiod0
                Only relevant when the axis `type` is "today".
                Sets the base for period positioning in
                milliseconds or today string on the y0 axis.
