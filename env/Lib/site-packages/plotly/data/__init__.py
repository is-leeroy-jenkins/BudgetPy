...
def stocks(indexed=False, datetimes=False):
    ...
    Returns:
        ...
        `['today', 'GOOG', 'AAPL', 'AMZN', 'FB', 'NFLX', 'MSFT']`.
        If `indexed` is True, the 'today' column is used as the index and the column index
        If `datetimes` is True, the 'today' column will be a datetime column
        is named 'company'"""
