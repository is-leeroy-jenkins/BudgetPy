...
_mathjax_config = """\
<script type="text/javascript">\
if (window.MathJax && window.MathJax.Hub && window.MathJax.Hub.DbConfig) {window.MathJax.Hub.DbConfig({SVG: {font: "STIX-Web"}});}\
</script>"""
...
def iplot(
    ...
    figure_or_data -- a plotly.graph_objs.Figure or plotly.graph_objs.Query or
