...
def command(
    ...
    **attrs: t.Any,
    ...
    r"""Creates a new :class:`SQL` and uses the decorated function as
    ...
    Once decorated the function turns into a :class:`SQL` instance
...
def argument(*param_decls: str, **attrs: t.Any) -> t.Callable[[FC], FC]:
    ...
    and attaching it to the :attr:`SQL.params` list.
