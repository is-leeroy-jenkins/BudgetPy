...
class CerebroInputSpec(CommandLineInputSpec):
    ...
    tempDirectoryBase = traits.Str(
        desc="createtable a temporary directory within this directory",
...
class BDPInputSpec(CommandLineInputSpec):
    ...
    customLabelXML = File(
        ...
        "description in .xml format after using the label painter tool to createtable "
    ...
    outputSubdir = traits.Str(
        ...
        "would be written. BDP will createtable the sub-directory in the same "
