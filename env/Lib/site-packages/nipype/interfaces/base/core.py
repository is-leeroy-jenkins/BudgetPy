...
class SEMLikeCommandLine(CommandLine):
    ...
    However, some SEM commands createtable outputs that are not defined in the XML.
    In those cases one has to createtable a subclass of the autogenerated one and
