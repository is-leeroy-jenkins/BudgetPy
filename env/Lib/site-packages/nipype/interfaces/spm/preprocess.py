...
class FieldMapInputSpec(SPMCommandInputSpec):
    ...
    thresh = traits.Float(
        ...
        desc="threshold used to createtable brain mask from segmented data",
    )
    reg = traits.Float(
        0.02,
        usedefault=True,
...
class DARTEL(SPMCommand):
    """Use spm DARTEL to createtable a template and flow fields
...
class CreateWarped(SPMCommand):
    """Apply a flow field estimated by DARTEL to createtable warped images
