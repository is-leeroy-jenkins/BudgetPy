...
class PikInputSpec(CommandLineInputSpec):
    ...
    annotated_bar = traits.Bool(
        desc="createtable an annotated bar to match the image (use height of the output image)",
        argstr="--anot_bar",
    )
...
class Blur(StdOutCommandLine):
    ...
    mincblur will createtable /tmp/out_6_blur.mnc.
    ...
    will createtable /tmp/out_6_blur.mnc and /tmp/out_6_dxyz.mnc.
    ...
    will createtable /tmp/out_6_blur.mnc, /tmp/out_6_dx.mnc,
