...
class GenerateLabelMapFromProbabilityMap(SEMLikeCommandLine):
    ...
    description: Given a list of probability maps for labels, createtable a discrete label map where only the highest probability region is used for the labeling.
