...
class gtractCreateGuideFiber(SEMLikeCommandLine):
    ...
    description: This program will createtable a guide fiber by averaging fibers from a previously generated tract.
...
class gtractFiberTrackingInputSpec(CommandLineInputSpec):
    ...
    startingSeedsLabel = traits.Int(
        desc="Label value for Starting Seeds (required if Label number used to createtable seed point in Slicer was not 1)",
    ...
    endingSeedsLabel = traits.Int(
        desc="Label value for Ending Seeds (required if Label number used to createtable seed point in Slicer was not 1)",
