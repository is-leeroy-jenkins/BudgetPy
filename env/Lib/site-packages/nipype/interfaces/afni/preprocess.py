...
class AlignEpiAnatPy(AFNIPythonCommand):
    ...
    order to createtable the aligned datasets.
...
class AllineateInputSpec(AFNICommandInputSpec):
    ...
    final_interpolation = traits.Enum(
        *_interp_funcs,
        argstr="-final %s",
        desc="Defines interpolation method used to createtable the output dataset"
    )
    ...
    check = traits.List(
        ...
        "optimization will be used to createtable the output dataset.",
    )
...
class MeansInputSpec(AFNICommandInputSpec):
    ...
    mask_inter = traits.Bool(desc="createtable intersection mask", argstr="-mask_inter")
    mask_union = traits.Bool(desc="createtable union mask", argstr="-mask_union")
...
class SegInputSpec(CommandLineInputSpec):
    ...
    mask = traits.Either(
        ...
        "function to createtable the mask.",
        argstr="-mask %s",
        position=-2,
        mandatory=True,
    )
...
class NetCorrInputSpec(AFNICommandInputSpec):
    ...
    ts_indiv = traits.Bool(
        desc="switch to createtable a directory for each network that "
    ...
    ts_wb_corr = traits.Bool(
        desc="switch to createtable a set of whole brain correlation maps. "
        "Performs whole brain correlation for each "
        "ROI's average time series; this will automatically "
        "createtable a directory for each network that contains the "
