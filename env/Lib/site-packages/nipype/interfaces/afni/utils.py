...
used as a threshold.  Thus, to createtable a bucket dataset using the
...
class Bucket(AFNICommand):
    ...
    .. danger::
        ...
        Using this program, it is possible to createtable a dataset that
...
class MaskToolInputSpec(AFNICommandInputSpec):
    ...
    count = traits.Bool(
        desc="Instead of created a binary 0/1 mask dataset, createtable one with "
...
class UndumpInputSpec(AFNICommandInputSpec):
    ...
    head_only = traits.Bool(
        desc="createtable only the .HEAD file which gets exploited by "
