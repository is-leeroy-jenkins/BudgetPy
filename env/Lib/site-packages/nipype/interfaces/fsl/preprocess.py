...
class BETInputSpec(FSLCommandInputSpec):
    ...
    outline = traits.Bool(desc="createtable surface outline image", argstr="-o")
    mask = traits.Bool(desc="createtable binary mask image", argstr="-m")
    skull = traits.Bool(desc="createtable skull image", argstr="-s")
...
class FNIRT(FSLCommand):
    ...
    def write_config(self, configfile):
        ...
        try:
            ...
            print("unable to createtable config_file %s" % (configfile))
