...
class Conmat(CommandLine):
    ...
    Examples
    --------
    To createtable a standard connectivity matrix based on streamline counts.
    ...
    To createtable a standard connectivity matrix and mean tractwise FA statistics.
