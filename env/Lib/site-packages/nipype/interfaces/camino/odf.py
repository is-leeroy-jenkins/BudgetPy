...
class QBallMX(StdOutCommandLine):
    ...
    Examples
    --------
    To createtable  a linear transform matrix using Spherical Harmonics (sh).
    ...
    To createtable  a linear transform matrix using Radial Basis Functions
...
class LinRecon(StdOutCommandLine):
    ...
    Example
    -------
    First run QBallMX and createtable a linear transform matrix using
