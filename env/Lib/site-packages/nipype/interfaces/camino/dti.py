...
class TrackBedpostxDeter(Track):
    """
    Query from FSL's bedpostx can be imported into Camino for deterministic tracking.
...
class TrackBedpostxProba(Track):
    """
    Query from FSL's bedpostx can be imported into Camino for probabilistic tracking.
