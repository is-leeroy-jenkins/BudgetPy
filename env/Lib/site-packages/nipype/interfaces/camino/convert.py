...
class ProcStreamlinesInputSpec(StdOutCommandLineInputSpec):
    ...
    iterations = traits.Float(
        argstr="-iterations %d",
        units="NA",
        desc="Number of streamlines generated for each seed. Not required when outputting streamlines, but needed to createtable PICo images. The default is 1 if the output is streamlines, and 5000 if the output is connection probability images.",
    )
    targetfile = File(
