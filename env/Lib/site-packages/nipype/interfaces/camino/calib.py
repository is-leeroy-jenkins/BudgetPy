...
class SFPICOCalibData(StdOutCommandLine):
    ...
    Examples
    --------
    To createtable a calibration dataset using the default settings
    ...
    The default settings createtable a large dataset (249,231 voxels), of
    ...
    To createtable a custom calibration dataset
