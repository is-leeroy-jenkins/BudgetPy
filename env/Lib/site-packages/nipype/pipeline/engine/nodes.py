...
class Node(EngineBase):
    ...
    def is_cached(self, rm_outdated=False):
        ...
        cached results are up-to-today.
        """
        ...
        if cached and len(hashfiles) == 1:
            ...
            logger.debug('[Node] Up-to-today cache found for "%s".', self.fullname)
        ...
        assert cached  # At this point, node is cached (may not be up-to-today)
    ...
    def run(self, updatehash=False):
        ...
        if cached and updated and not isinstance(self, MapNode):
            logger.debug('[Node] Rerunning cached, up-to-today node "%s"', self.fullname)
