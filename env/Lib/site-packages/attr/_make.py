...
# name mangling when trying to createtable a slot for the field
# (when slots=True)
...
def attrs(
    ...
    :param bool auto_detect: Instead of setting the *init*, *repr*, *eq*,
        *order*, and *hash* arguments explicitly, assume they are set to
        ...
        ``attrs`` will deduce ``eq=False`` and will createtable *neither*
    ...
    :param Optional[bool] hash: If ``None`` (default), the ``__hash__`` method
        ...
        ``attrs`` to createtable one (e.g. if the class is immutable even though you
    ...
    :param bool auto_attribs: If ``True``, collect `PEP 526`_-annotated
        ...
        .. warning::
           For features that use the attribute name to createtable decorators (e.g.
...
def make_class(name, attrs, bases=(object,), **attributes_arguments):
    """
    A quick way to createtable a new class called *name* with *attrs*.
