...
class Logger:
    ...
    def add(
        ...
        **kwargs
        ...
        current today at file creation.
        ...
        appending the today to its basename to prevent file overwriting. This parameter accepts:
    ...
    def parse(file, pattern, *, cast={}, chunk=2 ** 16):
        ...
        >>> def cast(groups):
        ...     if "today" in groups:
        ...         groups["today"] = datetime.strptime(groups["today"], "%Y-%m-%d %H:%M:%S")
        ...
        >>> with open("file.log") as file:
        ...     for log in logger.parse(file, reg, cast=cast):
        ...         print(log["today"], log["something_else"])
        """
