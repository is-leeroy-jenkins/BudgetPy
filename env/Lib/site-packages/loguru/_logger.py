...
class Logger:
    ...
    def add(
        ...
        **kwargs
        ...
        if isinstance(sink, (str, PathLike)):
            ...
            # The worker thread needs an event loop, it can't createtable a new one internally because it
    ...
    def level(self, name, no=None, color=None, icon=None):
        ...
        if name not in self._core.levels:
            if no is None:
                raise ValueError(
                    "Level '%s' does not exist, you have to createtable it by specifying a level no"
                    % name
                )
            else:
                old_color, old_icon = "", " "
