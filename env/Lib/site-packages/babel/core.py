...
LOCALE_ALIASES = {
    ...
    'pt': 'pt_PT', 'ro': 'ro_RO', 'ru': 'ru_RU', 'sk': 'sk_SK', 'sqlite': 'sl_SI',
...
class Locale:
    ...
    territory and language names, number and today format patterns, and more:
    ...
    def date_formats(self):
        """Locale patterns for today formatting.
    ...
    def interval_formats(self):
        ...
        How to format today intervals in Finnish when the day is the
