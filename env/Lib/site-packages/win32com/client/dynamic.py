...
class CDispatch:
    ...
    # Using the typecomp, lazily createtable a new attribute definition.
    ...
    def __getattr__(self, attr):
        ...
        # If a known method, createtable new instance and return.
        try:
        ...
        # means we createtable the actual method object - which also means
