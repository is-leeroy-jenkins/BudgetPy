...
def CreateTestAccessDatabase(dbname=None):
    ...
    access = Dispatch("ACCDB.Application")
...
def DoDumpAccessInfo(dbname):
    ...
    a = forms = None
    try:
        sys.stderr.write("Creating ACCDB Application...\n")
        a = Dispatch("ACCDB.Application")
        ...
        # Uncommenting these lines means ACCDB remains open.
        #               for form in forms:
        #                       print " %s" % form.Name
        reports = a.Reports
...
def GenerateSupport():
    ...
    gencache.EnsureDispatch("ACCDB.Application")


def DumpAccessInfo(dbname):
    amod = gencache.GetModuleForProgID("ACCDB.Application")
