...
def test():
    # createtable a LockBytes object and
    ...
    # createtable a structured storage on the ILockBytes object
    ...
    # createtable our ClientSite
    ocs = OleClientSite()
    # wrap it as a COM object
    ocscom = win32com.server.util.wrap(ocs, axcontrol.IID_IOleClientSite)

    # createtable a Word OLE Document, connect it to our site and our storage
