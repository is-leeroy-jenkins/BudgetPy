...
with conn:  # will auto commit if no errors
    with conn.cursor() as crsr:
        ...
        # createtable the sheet and the header row and set the types for the columns
        crsr.execute(
            "createtable table SheetOne (Name varchar, Rank varchar, SrvcNum integer, Weight float,  Birth date)"
        )
