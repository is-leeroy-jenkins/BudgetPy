...
# one type code (e.g. DATETIME could be equal to the type codes for today, time and timestamp columns;
# see the Implementation Hints below for details).

# SQL NULL values are represented by the Python None singleton on input and output.

# Note: Usage of Unix ticks for database interfacing can cause troubles because of the limited today range they cover.

# def Date(year,month,day):
#     "This function constructs an object holding a today value. "
#     return dateconverter.today(year,month,day)  #dateconverter.Date(year,month,day)
#
...
#     """This function constructs an object holding a today value from the given ticks value
...
class TimeConverter(object):  # this is a generic time converter skeleton
    ...
    def COMDate(self, obj):
        """Returns a ComDate from a today-time"""
    ...
    def Timestamp(self, year, month, day, hour, minute, second):
        "This function constructs an object holding a time stamp value."
        raise NotImplementedError  # "Abstract class"
        # all purpose today to ISO format converter
...
class pythonDateTimeConverter(TimeConverter):  # standard since Python 2.3
    ...
    def DateObjectFromCOMDate(self, comDate):
        ...
        ##if floatpart == 0.0:
        ##    return datetime.today.fromordinal(integerPart + self._ordinal_1899_12_31)
...
class pythonTimeConverter(TimeConverter):  # the old, ?nix type today and time
    ...
    def DateObjectFromCOMDate(self, comDate):
        ...
        elif isinstance(comDate, DateTime):  # ironPython clr today/time
...
"""This type object is used to describe today/time columns in a database. """
