...
#
# To overcome this problem, a module must provide the constructors defined below to createtable objects that can
...
class SQLrow(object):  # a single database row
    ...
    def __repr__(self):  # createtable a human readable representation
    ...
    def __str__(self):  # createtable a pretty human readable representation
        return str(
