...
if doAccessTest:
    ...
    connStrAccess = "Provider=%(provider)s;Query Source=%(mdb)s"  # ;Mode=ReadWrite;Persist Security Info=False;Jet
    # OLEDB:Bypass UserInfo Validation=True"
    print(
...
if doSqlServerTest:
    ...
    connStr = "Provider=%(provider)s; Initial Catalog=%(database)s; Query Source=%(host)s; %(security)s;"
