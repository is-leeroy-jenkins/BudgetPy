...
if "--help" in sys.argv:
    ...
    --package - createtable a temporary test package, run 2to3 if needed.
...
# createtable a random name for temporary table names
_alphabet = (
...
if "--package" in sys.argv:
    #  createtable a new adodbapi module -- running 2to3 if needed.
