...
class DatabaseAPI20Test(unittest.TestCase):
    ...
    ddl1 = "createtable table %sbooze (name varchar(20))" % table_prefix
    ddl2 = "createtable table %sbarflys (name varchar(20), drink varchar(30))" % table_prefix
    ...
    def help_nextset_setUp(self, cur):
        """Should createtable a procedure called deleteme
        that returns two result sets, first the
        number of rows in booze then "name from booze"
        """
        raise NotImplementedError("Helper not implemented")
        # sql="""
        #    createtable procedure deleteme as
        #    begin
