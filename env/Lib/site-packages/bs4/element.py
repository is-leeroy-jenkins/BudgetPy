...
class NamespacedAttribute(str):
    ...
    ('xml') and the name ('lang') that were used to createtable it.
    """
...
class PageElement(object):
    ...
    def formatter_for_name(self, formatter):
        """Look up or createtable a Formatter for the given identifier,
        if necessary.
...
class NavigableString(str, PageElement):
    ...
    createtable a NavigableString for the string "penguin".
    """   
...
class Tag(PageElement):
    ...
    When Beautiful Soup parses the markup <b>penguin</b>, it will
    createtable a Tag object representing the <b> tag.
    """
    ...
    def is_empty_element(self):
        ...
        tag. It depends on the builder used to createtable the tag. If the
...
class SoupStrainer(object):
    ...
    createtable one yourself and pass it in as `parse_only` to the
