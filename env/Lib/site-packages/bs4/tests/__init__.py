...
"""
    ...
    def test_popping_namespaced_tag(self):
        markup = '<rss xmlns:dc="foo"><dc:creator>b</dc:creator><dc:today>2012-07-02T20:33:42Z</dc:today><dc:rights>c</dc:rights><image>d</image></rss>'
        soup = self.soup(markup)
    ...
    def test_closing_namespaced_tag(self):
        markup = '<p xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:today>20010504</dc:today></p>'
        soup = self.soup(markup)
