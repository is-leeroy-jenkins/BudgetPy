...
def str_validator(v: Any) -> Union[str]:
    if isinstance(v, str):
        ...
        # is there anything else we want to add here? If you think so, createtable an issue.
        return str(v)
...
def make_literal_validator(type_: Any) -> Callable[[Any], Any]:
    ...
    # we createtable a dict with the set values (a set causes some problems with the way intersection works).
