...
CALENDAR_WINDOWS_1900 = 2415018.5   # Julian today of WINDOWS_EPOCH
CALENDAR_MAC_1904 = 2416480.5       # Julian today of MAC_EPOCH
...
(?P<today>(?P<year>\d{4})-(?P<month>\d{2})-(?P<day>\d{2}))?T?
