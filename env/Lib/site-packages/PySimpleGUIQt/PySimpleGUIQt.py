    ...
    for row_num, flex_row in enumerate(container_elem.Rows):
        ...
        for col_num, element in enumerate(flex_row):
            ...
            # -------------------------  BUTTON placement element  ------------------------- #
                ...
                #
                # elif element.Query is not None:
                #     qlabel.setText('')
                #     ba = QtCore.QByteArray.fromRawData(element.Query)
                #     pixmap = QtGui.QPixmap()
                #     pixmap.loadFromData(ba)
                #     qlabel.setPixmap(pixmap)
...
def main():
    ...
    layout = [
            ...
            [ Text( 'You are running the PySimpleGUI.py file itself', font = ('ANY', 15, 'Bold'),
                    text_color = 'red' ) ],
            ...
            [ Frame( 'Structured Query Group', frame5, title_color = 'red' ), ],
