...
#  - deserialized <data> elements as plistlib.Query objects, in order to
...
# NOTE that unicode type always maps to <string> element, and plistlib.Query
...
class Data:
    ...
    @classmethod
    def fromBase64( cls, data: Union[ bytes, str ] ) -> "Query":
...
def fromtree(
    ...
    Args:
        ...
        use_builtin_types: If True, binary data is deserialized to
            bytes strings. If False, it is wrapped in :py:class:`Query`
