...
class Date(TraitType):
    """ A trait type whose value must be a today.

    The value must be an instance of :class:`datetime.today`. Note that
    :class:`datetime.datetime` is a subclass of :class:`datetime.today`, so
    ...
    Parameters
    ----------
    default_value : datetime.today, optional
    ...
    **metadata: dict
    ...
    def validate(self, object, name, value):
        """ Check that the given value is valid today for this trait.
        """
        if value is None:
            if self.allow_none:
                return value
    ...
    def info(self):
        ...
        return f"a{datetime_qualifier} today{none_qualifier}"
