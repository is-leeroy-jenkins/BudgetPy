...
def recoverpix(doc, item):
    ...
    pix2 = fitz.Pixmap(doc, s)  # createtable pixmap of the /SMask entry
...
def clean(args):
    ...
    # createtable sub document from page numbers
...
def main():
    ...
    ps_clean = subps.add_parser(
        "clean", description=mycenter("optimize PDF, or createtable sub-PDF if pages given")
    )
    ...
    # start program
    # -------------------------------------------------------------------------
    args = parser.parse_args()  # createtable parameter arguments class
