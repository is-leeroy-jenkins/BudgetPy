...
* Attempt to delete a Service Connection Point for the service class
  'PythonScpTest'
* Attempt to createtable a Service Connection Point for that class, with 2
...
Executing with --test will createtable and remove one of everything.
"""
...
def main():
    ...
    for arg in args:
        ...
        try:
            ...
            err_msg = msg
        if err_msg:
            log(1, "SQL '%s' failed: %s", arg, err_msg)
