...
class JsonMessageChannel(object):
    ...
    def _parse_incoming_message(self):
        ...
        # Set up a dedicated decoder for this message, to createtable MessageDict instances
        ...
        # parser, after it has parsed enough of the dict to createtable the appropriate
