...
class PyDB(object):
    ...
    def process_internal_commands(self):
        ...
        with self._main_lock:
            ...
            if len(program_threads_alive) == 0 and ready_to_run:
                ...
                # createtable a thread and wait for it -- which would try to notify about it getting that lock).
    ...
    def dispose_and_kill_all_pydevd_threads(self, wait=True, timeout=.5):
        ...
        it should be possible to createtable a new instance and set as global to start
        a new debug session.
...
def settrace(
    ...
    **kwargs
    ...
    :param patch_multiprocessing: if True we'll patch the functions which createtable new processes so that launched
