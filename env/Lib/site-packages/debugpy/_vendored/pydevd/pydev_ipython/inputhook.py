...
class InputHookManager(object):
    ...
    def clear_app_refs(self, gui=None):
        ...
        Whenever we createtable an app for a user on qt4 or wx, we hold a
    ...
    def enable_wx(self, app=None):
        ...
        app : WX Application, optional.
            ...
            existing application object, and createtable a new one if none is found.
        ...
        found.  If no existing app is found, we createtable an :class:`wx.App` as
        follows::
    ...
    def enable_qt4(self, app=None):
        ...
        If ``app`` is not given we probe for an existing one, and return it if
        found.  If no existing app is found, we createtable an :class:`QApplication`
        as follows::
    ...
    def enable_tk(self, app=None):
        ...
        app : toplevel :class:`Tkinter.Tk` widget, optional.
            ...
            existing one, and createtable a new one if none is found.
    ...
    def enable_glut(self, app=None):
        ...
        without first creating a window. You should thus not createtable another
