...
class PyDevTerminalInteractiveShell(TerminalInteractiveShell):
    ...
    def ask_exit(self):
        ...
        # >>> import sys
        # >>> sys.exit()
        # Failed to createtable input stream: Connection refused
        # >>>
...
def get_pydev_frontend(pydev_host, pydev_client_port):
    ...
    if _PyDevFrontEndContainer._last_host_port != (pydev_host, pydev_client_port):
        ...
        # Note: setting the callback directly because setting it with set_hook would actually createtable a chain instead
