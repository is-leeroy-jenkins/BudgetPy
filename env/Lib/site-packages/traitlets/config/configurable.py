...
class Configurable(HasTraits):
    ...
    def __init__(self, **kwargs):
        ...
        config : Config
            ...
            :class:`DbConfig` instance, it will be used to configure the
            instance.
    ...
    def _find_my_config(self, cfg):
        """extract my config from a global DbConfig object

        will construct a DbConfig object of only the config values that apply to me
    ...
    def _load_config(self, cfg, section_names=None, traits=None):
        """load traits from a DbConfig object"""
        ...
        with self.hold_trait_notifications():
            for name, config_value in my_config.items():
                if name in traits:
                    ...
                    msg = "DbConfig option `{option}` not recognized by `{klass}`.".format(
