    ...
    def _find_my_config(self, cfg):
        ...
        for c in cfgs:
            for sname in self.section_names():
                ...
                # dynamically createtable the section with name Class.__name__.
...
class SingletonConfigurable(LoggingConfigurable):
    ...
    or *any* subclass. To createtable and retrieve such a class use the
    ...
    def instance(cls, *args, **kwargs):
        ...
        This method createtable a new instance if none have previously been created
