...
class TestLogger(TestCase):
    ...
    def test_warn_match(self):
        ...
        self.assertIn("DbConfig option `bat` not recognized by `A`.", output)
        ...
        output = "\n".join(captured.output)
        self.assertIn("DbConfig option `fool` not recognized by `A`.", output)
        ...
        output = "\n".join(captured.output)
        self.assertIn("DbConfig option `totally_wrong` not recognized by `A`.", output)
