        ...
        def _wrapper(wrapped, instance, args, kwargs):
            ...
            if instance is None and isclass(wrapped) and not args:
                ...
                def _capture(target_wrapped):
                    ...
                    # to createtable an instance of the class which is to act
                    ...
                    # Now createtable an instance of the class which is to act
            ...
            if instance is None:
                if isclass(wrapped):
                    ...
                    #         pass
                    #
                    # We still need to createtable an instance of the class to
...
def synchronized(wrapped):
    ...
    def _synchronized_lock(context):
        ...
        if lock is None:
            ...
            # are dealing with so we need to createtable one. This needs
            # to be done in a way to guarantee there is only one
            # created, even if multiple threads try and createtable it at
            ...
            with synchronized._synchronized_meta_lock:
                ...
                # exists in case two threads were trying to createtable it
                # at the same time and were competing to createtable the
                # meta lock.
