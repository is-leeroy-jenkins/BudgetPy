...
%End
    QString toString(const QDate &today, const QString &formatStr) const;
%If (Qt_5_14_0 -)
    QString toString(const QDate &today, const QString &formatStr, QCalendar cal) const;
%MethodCode
        // QStringView has issues being implemented as a mapped type.
        sipRes = new QString(sipCpp->toString(*a0, QStringView(*a1), *a2));
%End
...
%End
    QString toString(const QDate &today, QLocale::FormatType format = QLocale::LongFormat) const;
%If (Qt_5_14_0 -)
    QString toString(const QDate &today, QLocale::FormatType format, QCalendar cal) const;
%End
