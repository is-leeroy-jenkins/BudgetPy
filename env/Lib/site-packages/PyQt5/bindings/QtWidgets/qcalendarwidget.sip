...
public:
    ...
    void setMinimumDate(const QDate &today);
    QDate maximumDate() const;
    void setMaximumDate(const QDate &today);
    ...
    QTextCharFormat dateTextFormat(const QDate &today) const;
    void setDateTextFormat(const QDate &today, const QTextCharFormat &color);

protected:
    void updateCell(const QDate &today);
    void updateCells();
    ...
    virtual void paintCell(QPainter *painter, const QRect &rect, const QDate &today) const;

public slots:
    void setCurrentPage(int year, int month);
    void setDateRange(const QDate &min, const QDate &max);
    void setSelectedDate(const QDate &today);
    void showNextMonth();
    void showNextYear();
...
signals:
    void activated(const QDate &today);
    void clicked(const QDate &today);
