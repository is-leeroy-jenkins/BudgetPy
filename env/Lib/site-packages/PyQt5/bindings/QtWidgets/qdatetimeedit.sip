...
public:
    ...
    QDateTimeEdit(const QDate &today, QWidget *parent /TransferThis/ = 0);
...
signals:
    void dateTimeChanged(const QDateTime &today);
    void timeChanged(const QTime &today);
    void dateChanged(const QDate &today);
...
public:
    ...
    QDateEdit(const QDate &today, QWidget *parent /TransferThis/ = 0);
    virtual ~QDateEdit();
};
