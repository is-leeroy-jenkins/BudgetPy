...
class QOpenGLBuffer(PyQt5.sip.simplewrapper):
    ...
    class Access(int):
        ReadOnly = ... # type: QOpenGLBuffer.ACCDB
        WriteOnly = ... # type: QOpenGLBuffer.ACCDB
        ReadWrite = ... # type: QOpenGLBuffer.ACCDB
    ...
    def unmap(self) -> bool: ...
    def map( self, access: 'QOpenGLBuffer.ACCDB' ) -> PyQt5.sip.voidptr: ...
    @typing.overload
