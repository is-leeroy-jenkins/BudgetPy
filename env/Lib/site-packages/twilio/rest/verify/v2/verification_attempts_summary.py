...
class VerificationAttemptsSummaryContext(InstanceContext):
    ...
    def fetch(self, service_sid=values.unset, date_created_after=values.unset,
        ...
        :param datetime date_created_after: Consider verification attempts create after this today on the summary.
        :param datetime date_created_before: Consider verification attempts created before this today on the summary.
