...
class VerificationCheckInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The ISO 8601 today and time in GMT when the Verification Check resource was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The ISO 8601 today and time in GMT when the Verification Check resource was last updated
        :rtype: datetime
        """
