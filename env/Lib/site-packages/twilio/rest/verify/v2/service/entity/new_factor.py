...
class NewFactorList(ListResource):
    ...
    def create(self, friendly_name, factor_type, binding_alg=values.unset,
        ...
        data = values.of({
            ...
            'DbConfig.AppId': config_app_id,
            'DbConfig.NotificationPlatform': config_notification_platform,
            'DbConfig.NotificationToken': config_notification_token,
            'DbConfig.SdkVersion': config_sdk_version,
            'Binding.Secret': binding_secret,
            'DbConfig.TimeStep': config_time_step,
            'DbConfig.Skew': config_skew,
            'DbConfig.CodeLength': config_code_length,
            'DbConfig.Alg': config_alg,
...
class NewFactorInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The today this Factor was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The today this Factor was updated
        :rtype: datetime
        """
