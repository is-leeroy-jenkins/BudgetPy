...
class VerificationAttemptList(ListResource):
    ...
    def stream(self, date_created_after=values.unset,
        ...
        :param datetime date_created_after: Filter verification attempts after this today.
        :param datetime date_created_before: Filter verification attempts before this today.
...
class VerificationAttemptInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The today this Attempt was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The today this Attempt was updated
        :rtype: datetime
        """
