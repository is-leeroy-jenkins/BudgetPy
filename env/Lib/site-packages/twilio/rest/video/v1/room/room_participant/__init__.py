...
class ParticipantList(ListResource):
    ...
    def stream(self, status=values.unset, identity=values.unset,
        ...
        :param datetime date_created_after: Read only Participants that started after this today in UTC ISO 8601 format
        :param datetime date_created_before: Read only Participants that started before this today in ISO 8601 format
