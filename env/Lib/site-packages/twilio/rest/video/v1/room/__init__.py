...
class RoomList(ListResource):
    ...
    def stream(self, status=values.unset, unique_name=values.unset,
        ...
        :param datetime date_created_after: Read only rooms that started on or after this today, given as YYYY-MM-DD
        :param datetime date_created_before: Read only rooms that started before this today, given as YYYY-MM-DD
