...
class CompositionList(ListResource):
    ...
    def stream(self, status=values.unset, date_created_after=values.unset,
        ...
        :param datetime date_created_after: Read only Composition resources created on or after this `ISO 8601 <https://en.wikipedia.org/wiki/ISO_8601>`_ today-time with time zone
        :param datetime date_created_before: Read only Composition resources created before this ISO 8601 today-time with time zone
...
class CompositionInstance(InstanceResource):
    ...
    def date_deleted(self):
        """
        :returns: The ISO 8601 today and time in GMT when the composition generated media was deleted
        :rtype: datetime
        """
