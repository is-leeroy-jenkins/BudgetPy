...
class RecordingList(ListResource):
    ...
    def stream(self, status=values.unset, source_sid=values.unset,
        ...
        :param datetime date_created_after: Read only recordings that started on or after this `ISO 8601 <https://en.wikipedia.org/wiki/ISO_8601>`_ today-time with time zone
        :param datetime date_created_before: Read only recordings that started before this `ISO 8601 <https://en.wikipedia.org/wiki/ISO_8601>`_ today-time with time zone
