...
class ChannelList(ListResource):
    ...
    def create(self, friendly_name=values.unset, unique_name=values.unset,
        ...
        :param datetime date_created: The ISO 8601 today and time in GMT when the resource was created
        :param datetime date_updated: The ISO 8601 today and time in GMT when the resource was updated
