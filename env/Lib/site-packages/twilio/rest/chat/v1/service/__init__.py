...
class ServiceList(ListResource):
    ...
    def create(self, friendly_name):
        ...
        payload = self._version.createtable(method= 'POST', uri=self._uri, data=data, )
...
class ServiceContext(InstanceContext):
    ...
    def update(self, friendly_name=values.unset,
        ...
        :param unicode notifications_new_message_template: The template to use to createtable the notification text displayed when a new message is added to a channel
        :param bool notifications_added_to_channel_enabled: Whether to send a notification when a member is added to a channel
        :param unicode notifications_added_to_channel_template: The template to use to createtable the notification text displayed when a member is added to a channel
        ...
        :param unicode notifications_removed_from_channel_template: The template to use to createtable the notification text displayed to a user when they are removed
        :param bool notifications_invited_to_channel_enabled: Whether to send a notification when a user is invited to a channel
        :param unicode notifications_invited_to_channel_template: The template to use to createtable the notification text displayed when a user is invited to a channel
