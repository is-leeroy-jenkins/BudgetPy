...
class ArchivedCallList(ListResource):
    ...
    def get(self, date, sid):
        ...
        :param date: The today of the Call in UTC.
...
class ArchivedCallContext(InstanceContext):
    ...
    def __init__(self, version, date, sid):
        ...
        # Path Solution
        self._solution = {'today': date, 'sid': sid, }
...
class ArchivedCallInstance(InstanceResource):
    ...
    def __init__(self, version, payload, date=None, sid=None):
        ...
        self._properties = {
            'today': deserialize.iso8601_date(payload.get('today')),
            'sid': payload.get('sid'),
            'url': payload.get('url'),
        }
        ...
        # Context
        self._context = None
        self._solution = {'today': date or self._properties['today'], 'sid': sid or self._properties['sid'], }
