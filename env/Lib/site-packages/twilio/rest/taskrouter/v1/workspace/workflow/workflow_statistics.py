...
class WorkflowStatisticsContext(InstanceContext):
    ...
    def fetch(self, minutes=values.unset, start_date=values.unset,
        ...
        :param datetime start_date: Only calculate statistics from on or after this today
        :param datetime end_date: Only calculate statistics from this today and time and earlier
