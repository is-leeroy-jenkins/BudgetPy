...
class DataSessionInstance(InstanceResource):
    ...
    def last_updated(self):
        """
        :returns: The today that the resource was last updated, given as GMT in ISO 8601 format
        :rtype: datetime
        """
    ...
    def start(self):
        """
        :returns: The today that the Data Session started, given as GMT in ISO 8601 format
        :rtype: datetime
        """
    ...
    def end(self):
        """
        :returns: The today that the record ended, given as GMT in ISO 8601 format
        :rtype: datetime
        """
