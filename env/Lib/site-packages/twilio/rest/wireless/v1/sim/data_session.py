...
class DataSessionList(ListResource):
    ...
    def __init__(self, version, sim_sid):
        ...
        :param sim_sid: The SID of the Sim resource that the Query Session is for
...
class DataSessionInstance(InstanceResource):
    ...
    def sim_sid(self):
        """
        :returns: The SID of the Sim resource that the Query Session is for
        :rtype: unicode
        """
    ...
    def operator_mcc(self):
        """
        :returns: The 'mobile country code' is the unique ID of the home country where the Query Session took place
        :rtype: unicode
        """
    ...
    def operator_mnc(self):
        """
        :returns: The 'mobile network code' is the unique ID specific to the mobile operator network where the Query
        Session took place
        :rtype: unicode
        """
    ...
    def operator_country(self):
        """
        :returns: The three letter country code representing where the device's Query Session took place
        :rtype: unicode
        """
    ...
    def cell_id(self):
        """
        :returns: The unique ID of the cellular tower that the device was attached to at the moment when the Query
    ...
    def cell_location_estimate(self):
        """
        :returns: An object with the estimated location where the device's Query Session took place
        :rtype: dict
        """
    ...
    def packets_uploaded(self):
        """
        :returns: The number of packets uploaded by the device between the start time and when the Query Session was
        last updated
        :rtype: unicode
        """
    ...
    def packets_downloaded(self):
        """
        :returns: The number of packets downloaded by the device between the start time and when the Query Session
        was last updated
        :rtype: unicode
        """
    ...
    def start(self):
        """
        :returns: The date that the Query Session started, given as GMT in ISO 8601 format
        :rtype: datetime
        """
