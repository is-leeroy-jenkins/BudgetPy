...
class UsageRecordList(ListResource):
    ...
    def stream(self, end=values.unset, start=values.unset, granularity=values.unset,
        ...
        :param datetime end: Only include usage that has occurred on or before this today
        :param datetime start: Only include usage that has occurred on or after this today
