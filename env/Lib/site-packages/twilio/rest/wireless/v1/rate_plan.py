...
class RatePlanInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The today when the resource was created, given as GMT in ISO 8601 format
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The today when the resource was last updated, given as GMT in ISO 8601 format
        :rtype: datetime
        """
