...
class ChannelInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The ISO 8601 today and time in GMT when the Flex chat channel was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The ISO 8601 today and time in GMT when the Flex chat channel was last updated
        :rtype: datetime
        """
