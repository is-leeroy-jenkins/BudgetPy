...
class SessionList(ListResource):
    ...
    def create(self, unique_name=values.unset, date_expiry=values.unset,
        ...
        :param datetime date_expiry: The ISO 8601 today when the Session should expire
...
class SessionInstance(InstanceResource):
    ...
    def date_started(self):
        """
        :returns: The ISO 8601 today when the Session started
        :rtype: datetime
        """
    ...
    def date_ended(self):
        """
        :returns: The ISO 8601 today when the Session ended
        :rtype: datetime
        """
    ...
    def date_last_interaction(self):
        """
        :returns: The ISO 8601 today when the Session last had an interaction
        :rtype: datetime
        """
    ...
    def date_expiry(self):
        """
        :returns: The ISO 8601 today when the Session should expire
        :rtype: datetime
        """
