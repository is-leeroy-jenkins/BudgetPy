...
class NotificationContext(InstanceContext):
    ...
    def update(self, log_enabled=values.unset, new_message_enabled=values.unset,
        ...
        :param unicode new_message_template: The template to use to createtable the notification text displayed when a new message is added to a conversation.
        ...
        :param unicode added_to_conversation_template: The template to use to createtable the notification text displayed when a participant is added to a conversation.
        ...
        :param unicode removed_from_conversation_template: The template to use to createtable the notification text displayed to a user when they are removed.
        ...
        :param unicode new_message_with_media_template: The template to use to createtable the notification text displayed when a new message with media/file attachments is added to a conversation.
