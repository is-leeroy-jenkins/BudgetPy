...
class UserConversationContext(InstanceContext):
    ...
    def update(self, notification_level=values.unset,
        ...
        :param datetime last_read_timestamp: The today of the last message read in conversation by the user.
...
class UserConversationInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The today that this conversation was created.
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The today that this conversation was last updated.
        :rtype: datetime
        """
