...
class ExportCustomJobInstance(InstanceResource):
    ...
    def end_day(self):
        """
        :returns: The end day for the custom export specified as a string in the format of yyyy-MM-dd. This will be the last day exported. For instance, to export a single day, choose the same day for start and end day. To export the first 4 days of July, you would set the start today to 2020-07-01 and the end today to 2020-07-04. The end today must be the UTC day before yesterday.
        :rtype: unicode
        """
