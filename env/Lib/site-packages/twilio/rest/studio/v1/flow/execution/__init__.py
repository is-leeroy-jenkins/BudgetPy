...
class ExecutionList(ListResource):
    ...
    def stream(self, date_created_from=values.unset, date_created_to=values.unset,
        ...
        :param datetime date_created_from: Only show Executions that started on or after this ISO 8601 today-time
        :param datetime date_created_to: Only show Executions that started before this ISO 8601 today-time
