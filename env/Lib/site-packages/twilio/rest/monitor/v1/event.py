...
class EventList(ListResource):
    ...
    def stream(self, actor_sid=values.unset, event_type=values.unset,
        ...
        :param datetime start_date: Only include events that occurred on or after this today
        :param datetime end_date: Only include events that occurred on or before this today
...
class EventInstance(InstanceResource):
    ...
    def event_date(self):
        """
        :returns: The ISO 8601 today and time in GMT when the event was recorded
        :rtype: datetime
        """
