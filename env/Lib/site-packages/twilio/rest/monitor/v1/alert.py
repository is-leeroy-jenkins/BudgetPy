...
class AlertList(ListResource):
    ...
    def stream(self, log_level=values.unset, start_date=values.unset,
        ...
        :param datetime start_date: Only include alerts that occurred on or after this today and time
        :param datetime end_date: Only include alerts that occurred on or before this today and time
...
class AlertInstance(InstanceResource):
    ...
    def date_generated(self):
        """
        :returns: The today and time when the alert was generated specified in ISO 8601 format
        :rtype: datetime
        """
