...
class SecondaryAuthTokenInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The ISO 8601 formatted today and time in UTC when the resource was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The ISO 8601 formatted today and time in UTC when the resource was last updated
        :rtype: datetime
        """
