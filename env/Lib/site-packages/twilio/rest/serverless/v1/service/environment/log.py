...
class LogList(ListResource):
    ...
    def stream(self, function_sid=values.unset, start_date=values.unset,
        ...
        :param datetime start_date: The today and time after which the Log resources must have been created.
        :param datetime end_date: The today and time before which the Log resource must have been created.
...
class LogInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The ISO 8601 today and time in GMT when the Log resource was created
        :rtype: datetime
        """
