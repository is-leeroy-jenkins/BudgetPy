...
class BundleList(ListResource):
    ...
    def stream(self, status=values.unset, friendly_name=values.unset,
        ...
        :param unicode iso_country: The ISO country code of the country
        :param unicode number_type: The type of phone number
        :param bool has_valid_until_date: Indicates that the Bundle is a valid Bundle until a specified expiration today.
        :param BundleInstance.SortBy sort_by: Can be `valid-until` or `today-updated`. Defaults to `today-created`.
        :param BundleInstance.SortDirection sort_direction: Default is `DESC`. Can be `ASC` or `DESC`.
        :param datetime valid_until_date_before: Date to filter Bundles having their `valid_until_date` before or after the specified today. Can be `ValidUntilDate>=` or `ValidUntilDate<=`. Both can be used in conjunction as well.
        :param datetime valid_until_date: Date to filter Bundles having their `valid_until_date` before or after the specified today. Can be `ValidUntilDate>=` or `ValidUntilDate<=`. Both can be used in conjunction as well.
        :param datetime valid_until_date_after: Date to filter Bundles having their `valid_until_date` before or after the specified today. Can be `ValidUntilDate>=` or `ValidUntilDate<=`. Both can be used in conjunction as well.
...
class BundleInstance(InstanceResource):
    ...
    def valid_until(self):
        """
        :returns: The ISO 8601 today and time in GMT when the resource will be valid until.
        :rtype: datetime
        """
    ...
    def date_created(self):
        """
        :returns: The ISO 8601 today and time in GMT when the resource was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The ISO 8601 today and time in GMT when the resource was last updated
        :rtype: datetime
        """
