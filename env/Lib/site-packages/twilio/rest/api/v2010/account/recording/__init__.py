...
class RecordingList(ListResource):
    ...
    def stream(self, date_created_before=values.unset, date_created=values.unset,
        ...
        :param datetime date_created_before: Only include recordings that were created on this today
        :param datetime date_created: Only include recordings that were created on this today
        :param datetime date_created_after: Only include recordings that were created on this today
...
class RecordingInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The RFC 2822 today and time in GMT that the resource was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The RFC 2822 today and time in GMT that the resource was last updated
        :rtype: datetime
        """
