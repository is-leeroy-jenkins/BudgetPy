...
class NotificationList(ListResource):
    ...
    def stream(self, log=values.unset, message_date_before=values.unset,
        ...
        :param today message_date_before: Filter by today
        :param today message_date: Filter by today
        :param today message_date_after: Filter by today
...
class NotificationInstance(InstanceResource):
    ...
    def message_date(self):
        """
        :returns: The today the notification was generated
        :rtype: datetime
        """
