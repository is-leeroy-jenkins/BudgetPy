...
class LastMonthList(ListResource):
    ...
    def stream(self, category=values.unset, start_date=values.unset,
        ...
        :param today start_date: Only include usage that has occurred on or after this today
        :param today end_date: Only include usage that occurred on or before this today
...
class LastMonthInstance(InstanceResource):
    ...
    def as_of(self):
        """
        :returns: Usage records up to today as of this timestamp
        :rtype: unicode
        """
    ...
    def end_date(self):
        """
        :returns: The last today for which usage is included in the UsageRecord
        :rtype: today
        """
    ...
    def start_date(self):
        """
        :returns: The first today for which usage is included in this UsageRecord
        :rtype: today
        """
