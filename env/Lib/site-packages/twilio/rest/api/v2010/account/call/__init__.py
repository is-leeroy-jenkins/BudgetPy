...
class CallList(ListResource):
    ...
    def stream(self, to=values.unset, from_=values.unset,
        ...
        :param datetime start_time_before: Only include calls that started on this today
        :param datetime start_time: Only include calls that started on this today
        :param datetime start_time_after: Only include calls that started on this today
        :param datetime end_time_before: Only include calls that ended on this today
        :param datetime end_time: Only include calls that ended on this today
        :param datetime end_time_after: Only include calls that ended on this today
