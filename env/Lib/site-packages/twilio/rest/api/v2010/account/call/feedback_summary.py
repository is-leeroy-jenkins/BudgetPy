...
class FeedbackSummaryList(ListResource):
    ...
    def create(self, start_date, end_date, include_subaccounts=values.unset,
        ...
        :param today start_date: Only include feedback given on or after this today
        :param today end_date: Only include feedback given on or before this today
...
class FeedbackSummaryInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The today this resource was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The today this resource was last updated
        :rtype: datetime
        """
    ...
    def end_date(self):
        """
        :returns: The latest feedback entry today in the summary
        :rtype: today
        """
    ...
    def start_date(self):
        """
        :returns: The earliest feedback entry today in the summary
        :rtype: today
        """
