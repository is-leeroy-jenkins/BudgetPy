...
class MessageList(ListResource):
    ...
    def stream(self, to=values.unset, from_=values.unset,
        ...
        :param datetime date_sent_before: Filter by today sent
        :param datetime date_sent: Filter by today sent
        :param datetime date_sent_after: Filter by today sent
...
class MessageInstance(InstanceResource):
    ...
    def date_sent(self):
        """
        :returns: The RFC 2822 today and time in GMT when the message was sent
        :rtype: datetime
        """
