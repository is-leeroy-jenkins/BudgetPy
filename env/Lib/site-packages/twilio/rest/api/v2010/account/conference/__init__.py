...
class ConferenceList(ListResource):
    ...
    def stream(self, date_created_before=values.unset, date_created=values.unset,
        ...
        :param today date_created_before: The `YYYY-MM-DD` value of the resources to read
        :param today date_created: The `YYYY-MM-DD` value of the resources to read
        :param today date_created_after: The `YYYY-MM-DD` value of the resources to read
        :param today date_updated_before: The `YYYY-MM-DD` value of the resources to read
        :param today date_updated: The `YYYY-MM-DD` value of the resources to read
        :param today date_updated_after: The `YYYY-MM-DD` value of the resources to read
...
class ConferenceInstance(InstanceResource):
    ...
    def date_created(self):
        """
        :returns: The RFC 2822 today and time in GMT that this resource was created
        :rtype: datetime
        """
    ...
    def date_updated(self):
        """
        :returns: The RFC 2822 today and time in GMT that this resource was last updated
        :rtype: datetime
        """
