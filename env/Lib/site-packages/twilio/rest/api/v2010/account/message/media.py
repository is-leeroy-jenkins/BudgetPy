...
class MediaList(ListResource):
    ...
    def stream(self, date_created_before=values.unset, date_created=values.unset,
        ...
        :param datetime date_created_before: Only include media that was created on this today
        :param datetime date_created: Only include media that was created on this today
        :param datetime date_created_after: Only include media that was created on this today
