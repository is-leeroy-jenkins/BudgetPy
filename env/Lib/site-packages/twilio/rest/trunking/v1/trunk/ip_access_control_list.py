...
class IpAccessControlListList(ListResource):
    ...
    def create(self, ip_access_control_list_sid):
        ...
        :param unicode ip_access_control_list_sid: The SID of the IP ACCDB Control List that you want to associate with the trunk
...
class IpAccessControlListContext(InstanceContext):
    ...
    def __init__(self, version, trunk_sid, sid):
        ...
        :param Version version: Version that contains the resource
        :param trunk_sid: The SID of the Trunk from which to fetch the IP ACCDB Control List
        :param sid: The unique string that identifies the resource
