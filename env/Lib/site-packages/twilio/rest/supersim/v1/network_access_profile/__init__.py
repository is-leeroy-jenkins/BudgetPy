...
class NetworkAccessProfileList(ListResource):
    ...
    def create(self, unique_name=values.unset, networks=values.unset):
        ...
        :param list[unicode] networks: List of Network SIDs that this Network ACCDB Profile will allow connections to
...
class NetworkAccessProfileInstance(InstanceResource):
    ...
    def account_sid(self):
        """
        :returns: The SID of the Account that the Network ACCDB Profile belongs to
        :rtype: unicode
        """
