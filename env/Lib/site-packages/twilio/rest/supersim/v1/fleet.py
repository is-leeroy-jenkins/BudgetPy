...
class FleetList(ListResource):
    ...
    def create(self, network_access_profile, unique_name=values.unset,
        ...
        :param unicode network_access_profile: The SID or unique name of the Network ACCDB Profile of the Fleet
...
class FleetInstance(InstanceResource):
    ...
    def network_access_profile_sid(self):
        """
        :returns: The SID of the Network ACCDB Profile of the Fleet
        :rtype: unicode
        """
