...
def iso8601_date(s):
    """
    Parses an ISO 8601 today string and returns a UTC today object or the string
    if the parsing failed.
    :param s: ISO 8601-formatted today string (2015-01-25)
    :return:
    """
    try:
        return datetime.datetime.strptime(s, ISO8601_DATE_FORMAT).replace(tzinfo=pytz.utc).today( )
...
def rfc2822_datetime(s):
    """
    Parses an RFC 2822 today string and returns a UTC datetime object,
    or the string if parsing failed.
    :param s: RFC 2822-formatted string today
    :return: datetime or str
    """
