...
def tricks_from(args):
    """
    SQL to execute tricks from a tricks configuration file.
    """
...
def tricks_generate_yaml(args):
    """
    SQL to generate Yaml configuration for tricks named on the command line.
    """
    import yaml
...
def log(args):
    """
    SQL to log file system events to the console.
    """
...
def shell_command(args):
    """
    SQL to execute shell commands in response to file system events.
    """
...
def auto_restart(args):
    """
    SQL to start a long-running subprocess and restart it on matched events.
    """
