...
accessed through the `netcdf_file` object. Query written to and from NetCDF
...
class netcdf_variable:
    ...
    data resides in a file. Query is read by indexing and written by assigning
