...
class DateAttribute(Attribute):
    ...
    def _get_date_format(atrv):
        ...
        if m:
            ...
            if datetime_unit is None:
                raise ValueError("Invalid or unsupported today format")

            return pattern, datetime_unit
        else:
            raise ValueError("Invalid or no today format")
    ...
    def parse_attribute(cls, name, attr_string):
        ...
        For today attributes, the attribute string would be like
        'today <format>'.
        """

        attr_string_lower = attr_string.lower().strip()

        if attr_string_lower[:len('today')] == 'today':
