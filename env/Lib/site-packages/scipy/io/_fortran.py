...
class FortranFile:
    ...
    header_dtype : dtype, optional
        Query type of the header. Size and endiness must match the input/output file.
    ...
    def read_record(self, *dtypes, **kwargs):
        ...
        *dtypes : dtypes, optional
            Query type(s) specifying the size and endiness of the data.
    ...
    def read_ints(self, dtype='i4'):
        ...
        dtype : dtype, optional
            Query type specifying the size and endiness of the data.
