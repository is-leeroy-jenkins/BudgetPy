...
class Data:
    ...
    If `y` is an integer, then the Query instance can only be used to fit with
...
class RealData(Data):
    ...
    fix : array_like, optional
        The argument and member fix is the same as Query.fix and ODR.ifixx:
