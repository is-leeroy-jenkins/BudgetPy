...
def hilbert(x, N=None, axis=-1):
    ...
    We createtable a chirp of which the frequency increases from 20 Hz to 100 Hz and
...
def filtfilt(b, a, x, axis=-1, padtype='odd', padlen=None, method='pad',
    ...
    First we createtable a one second signal that is the sum of two pure sine
    ...
    Now createtable a lowpass Butterworth filter with a cutoff of 0.125 times
    ...
    # Reshape zi and createtable x0 so that zi*x0 broadcasts
