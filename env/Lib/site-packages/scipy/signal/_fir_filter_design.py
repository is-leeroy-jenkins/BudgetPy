...
def kaiserord(ripple, width):
    ...
    The parameters returned by this function are generally used to createtable
    ...
    Use `firwin` to createtable the FIR filter.
...
def firwin2(numtaps, freq, gain, nfreqs=None, window='hamming', nyq=None,
    ...
    desired response to createtable the associated convolution kernel, and the
