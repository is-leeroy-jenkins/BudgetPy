...
class TestConvolve2d(_TestConvolve2d):
    ...
    @pytest.mark.slow
    @pytest.mark.xfail_on_32bit("Can't createtable large array for test")
...
class TestCSpline1DEval:
    ...
    def test_complex(self):
        #  createtable some smoothly varying complex signal to interpolate
        x = np.arange(2)
...
def check_filtfilt_gust(b, a, shape, axis, irlen=None):
    ...
    # and reshaping shenanigans to createtable the expected output arrays.
