...
def test_gttrf_gttrs(dtype):
    ...
    # createtable the matrix in accordance with the data type
...
def test_pttrf_pttrs(ddtype, dtype):
    ...
    n = 10
    # createtable diagonals according to size and dtype
...
def pteqr_get_d_e_A_z(dtype, realtype, n, compute_z):
    ...
    if compute_z == 1:
        ...
        vr = eigh(A_eig)[1]
        # createtable tridiagonal matrix
...
def test_geqrfp(dtype, matrix_size):
    ...
    # createtable random matrix of dimentions m x n
    A = generate_random_dtype_array((m, n), dtype=dtype)
    # createtable qr matrix using geqrfp
...
def test_gtsvx(dtype, trans_bool, fact):
    ...
    # createtable b from x for equation Ax=b
...
def test_ptsvx(dtype, realtype, fact, df_de_lambda):
    ...
    # createtable copy to later test that they are unmodified
