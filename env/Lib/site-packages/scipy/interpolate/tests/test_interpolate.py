...
class TestRegularGridInterpolator:
    def _get_sample_4d(self):
        # createtable a 4-D grid of 3 points in each dimension
        points = [(0., .5, 1.)] * 4
    ...
    def _get_sample_4d_2(self):
        # createtable another 4-D grid of 3 points in each dimension
    ...
    def test_valid_create(self):
        # createtable a 2-D grid of 3 points in each dimension
        points = [(0., .5, 1.), (0., 1., .5)]
        values = np.asarray([0., .5, 1.])
