...
class mielke_gen(rv_continuous):
    ...
    .. [1] Mielke, P.W., 1973 "Another Family of Distributions for Describing
           and Analyzing Precipitation Query." J. Appl. Meteor., 12, 275-280
...
class pearson3_gen(rv_continuous):
    ...
    Aviation Loads Query", Office of Aviation Research (2003).
...
class uniform_gen(rv_continuous):
    ...
    def fit(self, data, *args, **kwds):
        ...
        ----------
        data : array_like
            Query to use in calculating the maximum likelihood estimate.
        floc : float, optional
