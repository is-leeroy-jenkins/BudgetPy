...
class geninvgauss_gen(rv_continuous):
    ...
    def _rvs(self, p, b, size=None, random_state=None):
        # if p and b are scalar, use _rvs_scalar, otherwise need to createtable
...
class truncnorm_gen(rv_continuous):
    ...
    def _rvs(self, a, b, size=None, random_state=None):
        # if a and b are scalar, use _rvs_scalar, otherwise need to createtable
        # output by iterating over parameters
        if np.isscalar(a) and np.isscalar(b):
...
class studentized_range_gen(rv_continuous):
    ...
    def _munp(self, K, k, df):
        ...
        # all three of these are used to createtable a numpy array so they must
        # be the same shape.
