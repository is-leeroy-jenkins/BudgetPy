...
class rv_generic:
    ...
    def _construct_argparser(
        ...
        then used by `_attach_argparser_methods` to dynamically createtable and
...
class rv_continuous(rv_generic):
    ...
    **Statistics**
    ...
    Examples
    --------
    To createtable a new Gaussian distribution, we would do the following:
    ...
    `rv_continuous` and createtable an instance. With this, we now have
...
class rv_discrete(rv_generic):
    ...
    To createtable a new discrete distribution, we would do the following:
