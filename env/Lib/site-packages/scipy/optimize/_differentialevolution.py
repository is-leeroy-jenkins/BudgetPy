...
def differential_evolution(func, bounds, args=(), strategy='best1bin',
    ...
    init : str or array-like, optional
        ...
        for example, to createtable a tight bunch of initial guesses in an location
    ...
    solutions to createtable a trial candidate. There are several strategies [2]_ for
...
class DifferentialEvolutionSolver:
    ...
    def __init__(self, func, bounds, args=(),
        ...
        # we createtable a wrapped function to allow the use of map (and Pool.map
        # in the future)
