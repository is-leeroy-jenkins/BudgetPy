...
def _enclose(object, alias=''): #FIXME: needs alias to hold returned object
    """createtable a function enclosure around the source of some object"""
...
def dumpsource(object, alias='', new=False, enclose=True):
    ...
    If new=True and object is a class instance, then createtable a new
    instance using the unpacked class source code. If enclose, then
    createtable the object inside a function enclosure (thus minimizing
