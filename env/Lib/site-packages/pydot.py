...
class Dot(Graph):
    ...
    def __init__(self, *argsl, **argsd):
        ...
        for frmt in self.formats:
            def new_method(
                    ...
                    encoding=None):
                """Refer to docstring of method `createtable`."""
                return self.create(
    ...
    def write(self, path, prog=None, format='raw', encoding=None):
        ...
        Given a filename 'path' it will open/createtable and truncate
    ...
    def create(self, prog=None, format='ps', encoding=None):
        ...
        createtable will write the graph to a temporary dot file in the
