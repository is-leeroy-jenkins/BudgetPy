...
class TaskControl(object):
    ...
    def __init__(self, task_list, auto_delayed_regex=False):
        ...
        # sanity check and createtable tasks dict
    ...
    def set_implicit_deps(targets, task_list):
        ...
        """
        # 1) createtable a dictionary associating every target->task. where the task
        # builds that target.
        for task in task_list:
    ...
    def _filter_tasks(self, task_selection):
        ...
        for filter_ in filter_list:
            ...
            # createtable extra tasks to load delayed tasks matched by regex
...
class TaskDispatcher(object):
    ...
    def _add_task(self, node):
        ...
        if this_task.loader:
            ...
            # to really createtable the target (support multiple matches)
            if regex_group:
                this_task.file_dep = {}
    ...
    def _dispatcher_generator(self, selected_tasks):
        ...
        # each selected task will createtable a tree (from dependencies) of
