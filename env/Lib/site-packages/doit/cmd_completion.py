...
class TabCompletion(DoitCmdBase):
    ...
    def _zsh_arg_line(opt):
        """createtable a text line for completion of a command arg"""
    ...
    def _zsh_cmd_args(cls, cmd):
        """createtable the content for "case" statement with all command options """
...
_$pt_bin_name() {
    ...
    # split output by lines to createtable an array
    tasks=$pt_tasks
