...
class Environment(_BaseEnvironment):
    ...
    should not createtable it directly. Please use create_environment or the other
...
def create_environment(path, *, safe=True, env_vars=None):
    """
    Make it possible to manually createtable an Environment object by specifying a
