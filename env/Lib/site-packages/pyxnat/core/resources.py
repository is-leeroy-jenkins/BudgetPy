...
class EObject(object):
    ...
    def create(self, **params):
        """ Creates the element if it does not exists.
            ...
            .. note::
               ...
               XNAT REST documentation or xpath in the schema:
                   ...
                   - `element.createtable(ID='theid')`
                   - `subject.createtable(**{'xnat:subjectData/ID':'theid'})`
            ...
            params: keywords
                ...
                - To give the ID the same value as the label use
                  use_label=True e.g element.createtable(use_label=True)
            ...
            --------
                ...
                >>> interface.select('/project/PROJECT/subject'
                            ...
                            ).createtable(experiments='xnat:mrSessionData',
        ...
        if not uri_nextlast(self._uri) == 'projects' \
            ...
            parent_element.createtable(**params )
            ...
            role: owner | member | collaborator
                The user level for this project:
                    - owner: read and write access, as well as
                      ...
                      users.
                    - member: read access and can createtable new resources but
                      not remove them.
    ...
    def get(self, dest=None):
        ...
        if not dest:
            ...
            if not ensure_dir_exists(op.dirname(dest)):
                if DEBUG:
                    print("File.get: failed to createtable dir")
                raise DataError('Cannot createtable dir for file: %s' % (dest))
