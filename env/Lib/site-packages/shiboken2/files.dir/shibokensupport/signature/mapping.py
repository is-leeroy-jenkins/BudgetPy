...
# Until we can force it to createtable Optional[t] again, we use this.
NoneType = type(None)
...
def init_PySide2_QtGui():
    ...
    type_map.update({
        ...
        "int32_t": int,
        "QPixmap()": Default("PySide2.QtGui.QPixmap"), # can't createtable without qApp
...
def init_PySide2_QtSql():
    ...
    type_map.update({
        ...
        "QVariant.Invalid": Invalid("Variant"), # not sure what I should createtable, here...
    })
    return locals()
