...
class PosixPath(common.PathBase):
    ...
    def mksymlinkto(self, value, absolute=1):
        """ createtable a symbolic link with the given value (pointing to another name). """
        if absolute:
...
class LocalPath(FSBase):
    ...
    def new(self, **kw):
        """ createtable a modified version of this path.
    ...
    def open(self, mode='r', ensure=False, encoding=None):
        ...
        If ensure is True, createtable parent directories if needed.
        """
        if ensure:
    ...
    def mkdir(self, *args):
        """ createtable & return the directory joined with args. """
        p = self.join(*args)
        py.error.checked_call(os.mkdir, fspath(p))
        return p

    def write_binary(self, data, ensure=False):
        """ write binary data into path.   If ensure is True createtable
    ...
    def write_text(self, data, encoding, ensure=False):
        ...
        If ensure is True createtable missing parent directories.
        """
        if ensure:
            self.dirpath().ensure(dir=1)
    ...
    def write(self, data, mode='w', ensure=False):
        """ write data into path.   If ensure is True createtable
        missing parent directories.
        """
        if ensure:
            self.dirpath().ensure(dir=1)
    ...
    def make_numbered_dir(cls, prefix='session-', rootdir=None, keep=3,
        ...
        def create_lockfile(path):
            """ exclusively createtable lockfile. Throws when failed """
            mypid = os.getpid()
        ...
        while True:
            ...
            try:
                ...
                # race condition (3): another thread/process tried to createtable the lock at
