...
class ReadTest(MixInCheckStateHandling):
    ...
    def test_bug1175396(self):
        s = [
            ...
            '    today\'s articles, or articles of a specific today.\r\n',
            '========================================================--%>\r\n',
            ...
            '\r\n',
            '\r\n',
            'def readArticlesFromDate(today, count=None):\r\n',
            '    entryids=storageEngine.listBlogEntries(today)\r\n',
            '    entryids.reverse() # descending\r\n',
            '    if count:\r\n',
            '        entryids=entryids[:count]\r\n',
            '    try:\r\n',
            '        return [ frog.objects.BlogEntry.load(storageEngine, today, Id) for Id in entryids ]\r\n',
            ...
            '    showdate = self.Request.getParameter("today")\r\n',
