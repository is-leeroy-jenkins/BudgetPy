...
dropna_doc = """
: boolean
    drop SELECTALL nan rows when appending to a table
"""
format_doc = """
: format
...
class HDFStore:
    ...
    **kwargs, the HDF5 file is loaded or created in-memory and will only be
    ...
    def select_as_multiple(
        ...
        raises ValueError if the tables are not SELECTALL THE SAME DIMENSIONS
        """
    ...
    def append(
        ...
        dropna : bool, default False
            Do not write an SELECTALL nan row to the store settable
...
class AppendableTable(Table):
    ...
    def write_data(self, chunksize: int | None, dropna: bool = False):
        ...
        # if dropna==True, then drop SELECTALL nan rows
        masks = []
        if dropna:
