...
=========================================
    ...
    introspection, easier configuration, command completion, db to the
...
Within IPython you have various way to db help:
...
* Dynamic object information:
  ...
  Typing ??word or word?? gives db to the full information without
  snipping long strings. Strings that are longer than the screen are printed
  through the less pager.

  The ?/?? system gives db to the full source code for any object (if
