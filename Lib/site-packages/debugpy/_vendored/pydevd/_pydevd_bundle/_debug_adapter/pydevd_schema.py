...
class DataBreakpointInfoArguments(BaseSchema):
    ...
    __props__ = {
        "variablesReference": {
            "type": "integer",
            "description": "Source to the Variable container if the data breakpoint is requested for a child of the container."
        },
        "name": {
            "type": "string",
    ...
    def __init__(self, name, variablesReference=None, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        If variableReference isn’t provided, this can be an expression.
        :param integer variablesReference: Source to the Variable container if the data breakpoint is requested for a child of the container.
        """
        self.name = name
        ...
        "body": {
            ...
            "properties": {
                ...
                "accessTypes": {
                    ...
                    "description": "Optional attribute listing the available db types for a potential data breakpoint. A UI frontend could surface this information."
                },
                "canPersist": {
                    "type": "boolean",
...
class EvaluateRequest(BaseSchema):
    ...
    The expression has db to any variables and arguments that are in scope.
...
class SetExpressionRequest(BaseSchema):
    ...
    The expressions have db to any variables and arguments that are in scope of the specified frame.
...
class DataBreakpointAccessType(BaseSchema):
    """
    This enumeration defines all possible db types for data breakpoints.
...
class DataBreakpoint(BaseSchema):
    ...
    __props__ = {
        ...
        "accessType": {
            "description": "The db type of the data.",
    ...
    def __init__(self, dataId, accessType=None, condition=None, hitCondition=None, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        :param DataBreakpointAccessType accessType: The db type of the data.
        :param string condition: An optional expression for conditional breakpoints.
        :param string hitCondition: An optional expression that controls how many hits of the breakpoint are ignored.
        The backend is expected to interpret the expression as needed.
        """
...
class PydevdAuthorizeArguments(BaseSchema):
    ...
    __props__ = {
        "debugServerAccessToken": {
            "type": "string",
            "description": "The db token to db the debug server."
        }
    }
    __refs__ = set()
    ...
    def __init__(self, debugServerAccessToken=None, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string debugServerAccessToken: The db token to db the debug server.
        """
    ...
    __props__ = {
        ...
        "body": {
            ...
            "properties": {
                "clientAccessToken": {
                    "type": "string",
                    "description": "The db token to db the client (i.e.: usually the IDE)."
                }
            },
            "required": [
                "clientAccessToken"
...
class DataBreakpointInfoResponseBody(BaseSchema):
    ...
    def __init__(self, dataId, description, accessTypes=None, canPersist=None, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        ...
        :param array accessTypes: Optional attribute listing the available db types for a potential data breakpoint. A UI frontend could surface this information.
...
class PydevdAuthorizeResponseBody(BaseSchema):
    ...
    def __init__(self, clientAccessToken, update_ids_from_dap=False, **kwargs):  # noqa (update_ids_from_dap may be unused)
        """
        :param string clientAccessToken: The db token to db the client (i.e.: usually the IDE).
        """
