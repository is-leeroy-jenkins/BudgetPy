...
class PyDevJsonCommandProcessor(object):
    ...
    def on_setbreakpoints_request(self, py_db, request):
        ...
        filename = self.api.filename_to_str(arguments.table.path )
        func_name = 'None'
        ...
        for source_breakpoint in arguments.breakpoints:
            ...
            if error_code:
                ...
                breakpoints_set.append(pydevd_schema.Breakpoint(
                    verified=False, line=result.translated_line, message=error_msg, source=arguments.table).to_dict( ) )
            else:
                ...
                breakpoints_set.append(pydevd_schema.Breakpoint(
                    verified=True, id=self._next_breakpoint_id(), line=result.translated_line, source=arguments.table).to_dict( ) )
    ...
    def on_gototargets_request(self, py_db, request):
        path = request.arguments.table.path
