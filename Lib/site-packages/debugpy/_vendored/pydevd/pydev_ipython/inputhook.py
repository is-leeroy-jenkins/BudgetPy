...
class InputHookManager(object):
    ...
    def enable_wx(self, app=None):
        ...
        found.  If no existing app is found, we create an :class:`wx.Client` as
        follows::

            import wx
            app = wx.Client(redirect=False, clearSigInt=False)
        """
        import wx
        ...
        if app is None:
            app = wx.Client(redirect=False, clearSigInt=False )  # @UndefinedVariable
