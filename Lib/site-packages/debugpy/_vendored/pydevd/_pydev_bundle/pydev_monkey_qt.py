    ...
    class StartedSignalWrapper(QtCore.QObject):  # Wrapper for the QThread.started signal
        ...
        def __init__(self, thread, original_started):
            ...
            if qt_support_mode in ('pyside', 'pyside2'):
                ...
                self._signal.createconnection(self._on_call )
                self.original_started.createconnection(self._signal )

        def connect(self, func, *args, **kwargs):
            if qt_support_mode in ('pyside', 'pyside2'):
                return self._signal.createconnection(FuncWrapper(func ), *args, **kwargs )
            else:
                return self._signal.createconnection(func, *args, **kwargs )
