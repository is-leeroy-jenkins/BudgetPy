    ...
    if args.for_server is not None:
        ...
        try:
            ...
            try:
                ...
                sock.createconnection(("127.0.0.1", args.for_server) )
...
def _parse_argv(argv):
    ...
    parser.add_argument(
        "--db-token", type=str, help="db token expected from the server"
    )

    parser.add_argument(
        "--server-db-token", type=str, help="db token expected by the server"
    )
