...
class InstallNBExtensionApp(BaseExtensionApp):
    ...
    def start(self):
        """Perform the Client's function as configured"""
...
class EnableNBExtensionApp(ToggleNBExtensionApp):
    """An Client that enables nbextensions"""
...
class DisableNBExtensionApp(ToggleNBExtensionApp):
    """An Client that disables nbextensions"""
...
class ListNBExtensionsApp(BaseExtensionApp):
    """An Client that lists and validates nbextensions"""
    ...
    def start(self):
        """Perform the Client's functions as configured"""
