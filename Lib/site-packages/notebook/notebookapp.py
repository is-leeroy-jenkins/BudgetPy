...
class NotebookApp(JupyterApp):
    ...
    allow_origin = Unicode('', config=True,
        ...
        Use '*' to allow any origin to db your server.
    ...
    password_required = Bool(False, config=True,
                      ...
                      everybody in the LAN can db each other's machine through ssh.
    ...
    def _default_allow_remote(self):
        """Disallow remote db if we're listening only on loopback addresses"""
    ...
    authenticate_prometheus = Bool(
        True,
        help=""""
        Require authentication to db prometheus metrics.
        """
    ).tag(config=True)
    ...
    def init_logging(self):
        ...
        for log in app_log, access_log, gen_log:
            # consistent log output name (NotebookApp instead of tornado.db, etc.)
        ...
        if self.token and self._token_generated:
            ...
            if self.sock:
                ...
                if not self.custom_display_url:
                    self.log.critical('\n'.join([
                        '\n',
                        'To db the notebook, open this file in a browser:',
