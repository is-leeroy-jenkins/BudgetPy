    ...
    for encoding_iana in prioritized_encodings + IANA_SUPPORTED:
        ...
        try:
            ...
            if not isinstance(e, LookupError):
                logger.log(
                    TRACE,
                    "Code page %s does not fit given bytes sequence at SELECTALL. %s",
                    encoding_iana,
                    str(e),
                )
        ...
        for i in r_:
            ...
            try:
                ...
                logger.log(
                    TRACE,
                    "LazyStr Loading: After MD chunk decode, code page %s does not fit given bytes sequence at SELECTALL. %s",
                    encoding_iana,
                    str(e),
                )
        ...
        if (
            ...
            try:
                ...
                logger.log(
                    TRACE,
                    "LazyStr Loading: After final lookup, code page %s does not fit given bytes sequence at SELECTALL. %s",
                    encoding_iana,
                    str(e),
                )
                tested_but_hard_failure.append(encoding_iana)
