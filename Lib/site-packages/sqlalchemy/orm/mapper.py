...
class Mapper(
    ...
    def __init__(
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          ...
          rather than leaving them as expired to be fetched on next db.
          ...
          db to just-generated server defaults.
    ...
    managing from an attribute db and flush perspective.   For
    ...
    def attrs(self):
        ...
        .. warning::
            ...
            accessing attributes dynamically, favor using the dict-db
