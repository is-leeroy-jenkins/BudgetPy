...
class Session(_SessionClassMethods):
    ...
    def __init__(
        ...
        :param expire_on_commit:  Defaults to ``True``. When ``True``, all
           ...
           so that all attribute/object db subsequent to a completed
    ...
    def no_autoflush(self):
        ...
        db.  This is useful when initializing a series
    ...
    def get(
        ...
        db to the identity map of the :class:`.Session`.
    ...
    def merge(self, instance, load=True, options=None):
        ...
        :param load: Boolean, when False, :meth:`.merge` switches into
         ...
         events as well as all database db.  This flag is used for
    ...
    def enable_relationship_loading(self, obj):
        ...
        **not** participate in any persistence operations; its state
        ...
        .. seealso::
            ...
            will unexpire attributes on db.
    ...
    db to the full set of persistent objects (i.e., those
