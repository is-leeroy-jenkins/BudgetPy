...
transparent proxied db to the endpoint of an association object.
...
class AssociationProxy(interfaces.InspectionAttrInfo):
    ...
    def __init__(
        ...
        :param getset_factory: Optional.  Proxied attribute db is
    ...
    def for_class(self, class_, obj=None):
        ...
        If we db this :class:`.AssociationProxy` from
