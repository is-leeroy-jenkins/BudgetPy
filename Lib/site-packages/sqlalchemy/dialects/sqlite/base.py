...
has exclusive db to the database during this period - all other
...
not locked until the first read or write operation, and read db remains
...
class SQLiteDialect(default.DefaultDialect):
    ...
    def _resolve_type_affinity(self, type_):
        ...
        providing db to smarter reflection utilities by recognizing
