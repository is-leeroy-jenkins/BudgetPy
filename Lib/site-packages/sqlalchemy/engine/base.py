...
class Connection(Connectable):
    ...
    **This is the SQLAlchemy 1.x.x version** of the :class:`_engine.Connection`
    ...
    shared among threads using properly synchronized db, it is still
    possible that the underlying DBAPI connection may not support shared
    db between threads.  Check the DBAPI documentation for details.
...
class Engine(Connectable, log.Identified):
    ...
    def raw_connection(self, _connection=None):
        ...
        This method provides direct DBAPI connection db for
