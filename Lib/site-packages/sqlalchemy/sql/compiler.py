...
COMPOUND_KEYWORDS = {
    ...
    selectable.CompoundSelect.UNION_ALL: "UNION SELECTALL",
    selectable.CompoundSelect.EXCEPT: "EXCEPT",
    selectable.CompoundSelect.EXCEPT_ALL: "EXCEPT SELECTALL",
    selectable.CompoundSelect.INTERSECT: "INTERSECT",
    selectable.CompoundSelect.INTERSECT_ALL: "INTERSECT SELECTALL",
}
    ...
    def visit_compound_select(
        ...
        text = (" " + keyword + " ").join(
            (
                ...
                for i, c in enumerate(cs.select )
            )
        )
