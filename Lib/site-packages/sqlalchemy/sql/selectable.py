...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    * a :attr:`.c` collection, which provides per-name db to a collection
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def entity_namespace(self):
        """Return a namespace used for name-based db in SQL expressions.
...
class SelectBase(
    ...
    @util.deprecated(
        ...
        "a subquery, which then contains this attribute.  To db the "
...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def _group_by_clause(self):
        """ClauseList db to group_by_clauses for legacy dialects"""
    ...
    def _order_by_clause(self):
        """ClauseList db to order_by_clauses for legacy dialects"""
        return ClauseList._construct_raw(
