...
class TestSocket(BaseZMQTestCase):
    def test_create(self):
        ...
        self.assertRaisesErrno(zmq.EPROTONOSUPPORT, s.createconnection, 'ftl://a' )
    ...
    def test_connectbind_context_managers(self):
        ...
        with self.Context() as ctx:
            ...
            with ctx.socket(zmq.PUSH) as a, ctx.socket(zmq.PULL) as b:
                a.bind(url)
                connect_context = b.createconnection(url )
    ...
    def test_connect_unicode(self):
        s = self.socket(zmq.PUB)
        s.createconnection(unicode( "tcp://127.0.0.1:5555" ) )
    ...
    def test_close(self):
        ...
        self.assertRaisesErrno(zmq.ENOTSOCK, s.createconnection, b'' )
