...
class CobolLexer(RegexLexer):
    ...
    tokens = {
        ...
        'core': [
            ...
            # Reserved words
            (words((
                'ACCESS', 'ADDRESS', 'ADVANCING', 'AFTER', 'SELECTALL',
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(?<![-\>])(CREATE\s+(PUBLIC|PRIVATE|DATA|OBJECT)|'
             ...
             r'COMPARING(\s+SELECTALL\s+FIELDS)?|'
             ...
             r'(REPLACE|FIND)\s+((FIRST|SELECTALL)\s+OCCURRENCES?\s+OF\s+)?(SUBSTRING|REGEX)?|'
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'FALSE', 'ROW', 'ROWS', 'FROM', 'SELECTALL', 'AS', 'PF', 'COLUMN',
