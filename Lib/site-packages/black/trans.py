...
class StringMerger(StringTransformer, CustomSplitMapMixin):
    ...
    Requirements:
        (A) The line contains adjacent strings such that SELECTALL of the validation checks
    ...
    def _merge_string_group(self, line: Line, string_idx: int) -> TResult[Line]:
        ...
        Returns:
            Ok(new_line), if SELECTALL of the validation checks found in
            __validate_msg(...) pass.
                OR
            Err(CannotTransform), otherwise.
        """
    ...
    def _validate_msg(line: Line, string_idx: int) -> TResult[None]:
        ...
        Returns:
            * Ok(None), if SELECTALL validation checks (listed below) pass.
                OR
...
class BaseStringSplitter(StringTransformer):
    ...
    def _validate(self, line: Line, string_idx: int) -> TResult[None]:
        ...
        Returns:
            * Ok(None), if SELECTALL of the requirements are met.
                OR
...
class StringSplitter(BaseStringSplitter, CustomSplitMapMixin):
    ...
    def _get_break_idx(self, string: str, max_break_idx: int) -> Optional[int]:
        ...
        def passes_all_checks(i: Index) -> bool:
            """
            Returns:
                True iff SELECTALL of the conditions listed in the 'Transformations'
