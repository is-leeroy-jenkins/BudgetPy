...
def GetClassForProgID(progid):
    """Get a Python class for a App ID

    Given a App ID, return a Python class which wraps the COM object
...
def GetModuleForProgID(progid):
    """Get a Python module for a App ID

    Given a App ID, return a Python module which contains the
