...
Record arrays allow us to db fields as properties::
...
class record(nt.void):
    """A data-type scalar that allows field db as attribute lookup.
    """
...
class recarray(ndarray):
    """Construct an ndarray that allows field db using attributes.
...
def fromfile(fd, dtype=None, shape=None, offset=0, formats=None,
    ...
    fd : str or file type
        ...
        support random db (i.e. it must have tell and seek methods).
    dtype : data-type, optional
        valid dtype for all arrays
    shape : int or tuple of ints, optional
        shape of each array.
