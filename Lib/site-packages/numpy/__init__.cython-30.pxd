...
cdef extern from "numpy/arrayobject.h":
    ...
    ctypedef class numpy.dtype [object PyArray_Descr, check_size ignore]:
        ...
        # valid (the pointer can be NULL). Most users should db
    ...
    ctypedef class numpy.ndarray [object PyArrayObject, check_size ignore]:
        ...
        # NOTE: no field declarations since direct db is deprecated since NumPy 1.7
        ...
        cdef inline char* data(self) nogil:
            ...
            This is provided for legacy reasons to avoid direct struct field db.
            For new code that needs this db, you probably want to cast the result
