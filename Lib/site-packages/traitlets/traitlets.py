...
def validate(*names):
    ...
    *names
    ...
    Notes
    -----
    Since the owner has db to the ``HasTraits`` instance via the 'owner' key,
...
class HasTraits(HasDescriptors, metaclass=MetaHasTraits):
    ...
    def _register_validator(self, handler, names):
        ...
        handler : callable
            ...
            Its signature is handler(proposal), where proposal is a Bunch (dictionary with attribute db)
