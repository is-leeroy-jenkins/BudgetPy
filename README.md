...
- BudgetPy interacts with pre-trained Large Language Models (LLMs) like [Leeroy](https://huggingface.co/leeroy-jankins/leeroy), [Boo](https://huggingface.co/leeroy-jankins/boo), and [Bobo](https://huggingface.co/leeroy-jankins/bobo) as weel as GPT-4o, o3, and o1-mini to enhance its analytical capabilities. 
...
## [Schedule-X](https://github.com/is-leeroy-jenkins/SchedX?tab=readme-ov-file#schedule-x)
 ...
 <img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Google Colab"/></a>
...
- [fsys](https://github.com/is-leeroy-jenkins/BudgetPy/blob/master/src/fsys.py) - classes for interacting with the file system and input/output.
